/* 
 * Форма создания направления на исследование образцов крови в ИФА на антитела к ВИЧ
 */


Ext.define('common.BSME.ForenCorp.SecretaryWP.tools.swCreateBludSampleDirection', {
	extend: 'Ext.window.Window',
    autoShow: true,
	modal: true,
	width: '50%',
	height: '50%',
	refId: 'forencorpcreatebludsampledirectionwnd',
	closable: true,
	title: 'Направление на исследование образцов крови в ИФА на антитела к ВИЧ',
	id: 'ForenCorpCreateBludSampleDirectionWindow',
	border: false,
	layout: {
        align: 'stretch',
        type: 'vbox'
		...
		this.BaseForm = Ext.create('sw.BaseForm',{
			...
			items: [{
				...
				},
				{
					...
					xtype: 'datefield',
					fieldLabel: 'Дата забора',
					allowBlank: true,
					name: 'EvnForensic_TakeDate',
					format: 'd.m.Y',
...
//						loadMask.show();
					this.BaseForm.submit({
						params : params,
						url: '/?c=BSME&m=saveForenBludSampleDirection',
						success: function(form, action) {
							...
							Ext.Ajax.request({
								url: '/?c=BSME&m=printBludSampleResearchDirection',
								params: {
