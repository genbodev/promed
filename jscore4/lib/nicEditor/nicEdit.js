...
buttons : {
	...
	iconsPath : './jscore4/lib/nicEditor/nicEditorIcons.gif',
	...
	iconFiles: {'swpastefromword': '/img/icons/paste-doc18.png'}
});
/* END CONFIG */
...
var swPasteFromWordButton = nicEditorButton.extend({
    mouseClick : function() {
		...
		Ext.MessageBox.show({
			...
			msg: 'Пожалуйста, вставьте текст, используя сочетание клавиш (Ctrl+V), и нажмите кнопку OK',
			width:300,
