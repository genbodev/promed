				...
				<table class="outer" width="100%">
					<tr class="outer">
						<th class="outer" width="20%">
							<xsl:text>Ребёнок:</xsl:text>
						</th>
						<td class="outer">
							<xsl:text> </xsl:text>
							<xsl:value-of select='//n1:observation[n1:code/@code="380"][n1:code/@codeSystem="1.2.643.5.1.13.13.11.1380"]/n1:value/@value'/>
							<xsl:text>й из </xsl:text>
							<xsl:value-of select='//n1:observation[n1:code/@code="310"][n1:code/@codeSystem="1.2.643.5.1.13.13.11.1380"]/n1:value/@value'/>
							<xsl:if test='//n1:observation[n1:code/@code="310"][n1:code/@codeSystem="1.2.643.5.1.13.13.11.1380"]/n1:value/@value > 1'><xsl:text>х</xsl:text></xsl:if>				
							<xsl:text> ( </xsl:text>
							<b>
