Ext6.define('usluga.associatedwindows.uslugaDynamicsOfTestResults', {
	alias: 'widget.uslugaDynamicsOfTestResults',
	...
	show: function() {
        ...
        Ext6.Ajax.request({
			url: '/?c=Template&m=getDynamicsOfTestResultsForm',
			params: params,
	...
	printHtml: function() {
		...
		win.document.write('<html><head><title>Параметры</title><link href="/css/emk.css?' + id_salt + '" rel="stylesheet" type="text/css" /></head><body id="rightEmkPanelPrint">' + s.dom.innerHTML + '</body></html>');
		var i, el;
