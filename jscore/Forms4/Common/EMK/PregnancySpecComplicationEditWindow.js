...
* 
*/
Ext6.define('common.EMK.PregnancySpecComplicationEditWindow', {
	alias: 'widget.swPregnancySpecComplicationEditWindowExt6',
	height: 195,
	...
	enableEdit: function(enable) {
		...
		var form_fields = new Array('PSCEF_PregnancySpecComplication_id', 'PSCEF_PregnancySpec_id', 'PSCEF_PSC_setDT', 'Diag_id');
		var i = 0;
