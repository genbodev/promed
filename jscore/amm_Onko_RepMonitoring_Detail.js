...
sw.Promed.amm_Onko_RepMonitoring_Detail = Ext.extend(sw.Promed.BaseForm, {
	id: 'amm_Onko_RepMonitoring_Detail',
        title: 'Отчет  "Мониторинг реализации системы "Онкоконтроль": детализация',
	border: false,
	width: 725,
	height: 500,
	maximized: true,
	...
	initComponent: function() {
		...
		this.ViewFrameRepMonitoringDetail = new sw.Promed.ViewFrame(
		{
			...
			[
                        ...
                        {name: 'SurName', type: 'string', header: 'Фамилия', width: 120},
                        {name: 'FirName', type: 'string', header: 'Имя', width: 120},
                        {name: 'SecName', type: 'string', header: 'Отчество', width: 120},
                        {name: 'BirthDay', type: 'date', header: 'Дата<br>рождения ', width: 90},
                        {name: 'Prof_DtBeg', type: 'date', header: 'Дата анкетирования', width: 90},
                        {name: 'Prof_ProfileResult', type: 'string', header: 'Результат', width: 150},
                        {name: 'Prof_MedPersonal_fio', type: 'string', header: 'Врач (анкетирование)', width: 180},
                        {name: 'Diag_Date', type: 'date', header: 'Дата <br>диагноза', width: 90},
                        {name: 'Diag_Code', type: 'string', header: 'Код <br>диагноза', width: 90},
                        {name: 'Diag_Name', type: 'string', header: 'Наименование<br>диагноза',id: 'autoexpand'},
                        {name: 'Diag_MedPersonal_fio', type: 'string', header: 'Врач (диагноз)', width: 180}
	...
	show: function(record) {
                ...
                sw.Promed.vac.utils.consoleLog('форма amm_RepSetZNO_Detail');
