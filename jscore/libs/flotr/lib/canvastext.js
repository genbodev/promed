 ...
 * It as been modified by Fabien Mйnager to handle font style like size, weight, color and rotation. 
...
var CanvasText = {
  ...
  letters: {
    ...
    // Lower case Latin-1
    'а': { diacritic: '`', letter: 'a' },
    'б': { diacritic: 'ґ', letter: 'a' },
    'в': { diacritic: '^', letter: 'a' },
    'д': { diacritic: 'Ё', letter: 'a' },
    'г': { diacritic: '~', letter: 'a' },
    
    'и': { diacritic: '`', letter: 'e' },
    'й': { diacritic: 'ґ', letter: 'e' },
    'к': { diacritic: '^', letter: 'e' },
    'л': { diacritic: 'Ё', letter: 'e' },
    
    'м': { diacritic: '`', letter: 'i' },
    'н': { diacritic: 'ґ', letter: 'i' },
    'о': { diacritic: '^', letter: 'i' },
    'п': { diacritic: 'Ё', letter: 'i' },
    
    'т': { diacritic: '`', letter: 'o' },
    'у': { diacritic: 'ґ', letter: 'o' },
    'ф': { diacritic: '^', letter: 'o' },
    'ц': { diacritic: 'Ё', letter: 'o' },
    'х': { diacritic: '~', letter: 'o' },

    'щ': { diacritic: '`', letter: 'u' },
    'ъ': { diacritic: 'ґ', letter: 'u' },
    'ы': { diacritic: '^', letter: 'u' },
    'ь': { diacritic: 'Ё', letter: 'u' },
    
    'э': { diacritic: 'ґ', letter: 'y' },
    'я': { diacritic: 'Ё', letter: 'y' },
    
    'з': { diacritic: 'ё', letter: 'c' },
    'с': { diacritic: '~', letter: 'n' },
  ...
  diacritics: {
    'ё': { entity: 'cedil', points: [[6,-4],[4,-6],[2,-7],[1,-7]] },
    'ґ': { entity: 'acute', points: [[8,19],[13,22]] },
    '`': { entity: 'grave', points: [[7,22],[12,19]] },
    '^': { entity: 'circ',  points: [[5.5,19],[9.5,23],[12.5,19]] },
    'Ё': { entity: 'trema', points: [[5,21],[6,20],[7,21],[6,22],[5,21],null,[12,21],[13,20],[14,21],[13,22],[12,21]] },
