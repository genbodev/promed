...
Ext.DateRangePicker = Ext.extend(Ext.Component, {
    ...
    syncMonthChange: false,

    showApply : true,

    applyText : langs('Выбрать'),

    applyTip : "Выбрать дату (Enter)",
    ...
    initComponent : function(){
        Ext.DateRangePicker.superclass.initComponent.call(this);
    ...
    onRender : function(container, position){
        var m = [
             '<table cellspacing="0">',
                '<tr><td class="x-date-left1"><a href="#" title="', this.prevText ,'">&#160;</a></td><td class="x-date-middle1" align="center"></td><td class="x-date-right1"><a href="#" title="', this.nextText ,'">&#160;</a></td><td class="x-date-left2"><a href="#" title="', this.prevText ,'">&#160;</a></td><td class="x-date-middle2" align="center"></td><td class="x-date-right2"><a href="#" title="', this.nextText ,'">&#160;</a></td></tr>',
                '<tr><td colspan="3">'];
        m.push('<table class="x-date-inner1" cellspacing="0" style="border-right:1px solid #1b376c;"><thead><tr>');
        ...
        m.push('<td colspan="3"><table class="x-date-inner2" cellspacing="0"><thead><tr>');
        var dn = this.dayNames;
        for(var i = 0; i < 7; i++){
            var d = this.startDay+i;
            if(d > 6){
        ...
        m.push('</tr></tbody></table></td></tr>',
                '<tr><td colspan="3" class="x-date-bottom" align="center"><div class="x-date-bottom1" style="float:center;"></div></td><td colspan="3" class="x-date-bottom" align="center"><div class="x-date-bottom2" style="float:center;"></div></td></tr>',
                '<tr><td colspan="6" class="x-date-bottom" align="center"><div class="x-date-bottom3" style="float:center;"></div></td></tr>',
                '</table><div class="x-date-mp1"></div><div class="x-date-mp2"></div>');
        ...
        if(this.showApply){
            this.applyKeyListener = this.eventEl.addKeyListener(Ext.EventObject.ENTER, this.applyClicked,  this);
            this.applyBtn = new Ext.Button({
                renderTo: this.el.child("div.x-date-bottom3", true),
                text: this.applyText,
                tooltip: this.applyTip,
                handler: this.applyClicked,
                scope: this,
                minWidth: 260
            });
        }
    ...
    showPrevMonth1 : function(e){
        ...
        if(this.syncMonthChange)
        {
            ...
            var curDate = new Date(this.activeDate1);
            var minDate = new Date(curDate.getFullYear(),curDate.getMonth(),1);
            var maxDate = new Date(curDate.getFullYear(),curDate.getMonth()+1,0);
    ...
    showPrevMonth2 : function(e){
        ...
        {
            this.setValue1(this.activeDate1.add("mo", -1));
            var curDate = new Date(this.activeDate2);
            var minDate = new Date(curDate.getFullYear(),curDate.getMonth(),1);
            var maxDate = new Date(curDate.getFullYear(),curDate.getMonth()+1,0);
            this.setMinDate(minDate);
            this.setMaxDate(maxDate);
...
Ext.reg('daterangepicker', Ext.DateRangePicker);

Ext.form.DateRangeField = Ext.extend(Ext.form.TriggerField,  {
    ...
    syncMonthChange: false, //Синхронная смена месяцев

    format : "d.m.Y",

    // Не стоит убирать этот параметр - без него перестают работать навешанные события на нажатия кнопок, а это используется на многих формах
    ...
    initComponent : function(){
        Ext.form.DateRangeField.superclass.initComponent.call(this);
    ...
    onDestroy : function(){
        ...
        Ext.form.DateRangeField.superclass.onDestroy.call(this);
    },
    ...
    onTriggerClick : function(){
        ...
        if(this.menu == null){
            this.menu = new Ext.menu.DateRangeMenu();
        }
        Ext.apply(this.menu.picker,  {
            ...
            syncMonthChange: this.syncMonthChange,
...
Ext.reg('daterangefield', Ext.form.DateRangeField);

Ext.menu.DateRangeItem = function(config){
    Ext.menu.DateItem.superclass.constructor.call(this, new Ext.DateRangePicker(config), config);
...
Ext.extend(Ext.menu.DateRangeItem, Ext.menu.Adapter, {
    // private
    onSelect : function(picker, date){
        this.fireEvent("select", this, date, picker);
        Ext.menu.DateRangeItem.superclass.handleClick.call(this);
    }
});

Ext.menu.DateRangeMenu = function(config){
    Ext.menu.DateRangeMenu.superclass.constructor.call(this, config);
    this.plain = true;
    var di = new Ext.menu.DateRangeItem(config);
    this.add(di);
...
Ext.extend(Ext.menu.DateRangeMenu, Ext.menu.Menu, {
    cls:'x-date-menu',
