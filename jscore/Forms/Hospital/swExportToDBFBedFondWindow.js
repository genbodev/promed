/**
* Стационар: Форма выгрузки данных по коечному фонду
*
...
sw.Promed.swExportToDBFBedFondWindow = Ext.extend(sw.Promed.BaseForm,
{
	title: lang['vyigruzka_dannyih_po_koechnomu_fondu'],
	modal: true,
	height: 145,
	width: 350,
	shim: false,
	...
	layout: 'fit',
	buttonAlign: "right",
	objectName: 'swExportToDBFBedFondWindow',
	closeAction: 'hide',
	id: 'swExportToDBFBedFondWindow',
	objectSrc: '/jscore/Forms/Hospital/swExportToDBFBedFondWindow.js',
	buttons: [
		{
			handler: function()
			{
	...
	show: function()
	{
		sw.Promed.swExportToDBFBedFondWindow.superclass.show.apply(this, arguments);
	...
	initComponent: function()
	{
		...
		sw.Promed.swExportToDBFBedFondWindow.superclass.initComponent.apply(this, arguments);
	}
});