...
sw.Promed.swCmpCallCardNewCloseCardWindow = Ext.extend(sw.Promed.swMainCloseCardWindow,{
	...
	/**
	 * Для Пскова функция ничего не делает, ибо EmergencyTeam_id - hidden, а не combo
	 * @task https://redmine.swan.perm.ru/issues/100860
	 */
	//loadEmergencyTeamsWorkedInATime: Ext.emptyFn,
