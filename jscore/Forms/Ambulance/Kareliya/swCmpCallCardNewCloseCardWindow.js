					...
					}, 
					{
						...
						items : [
							...
							},
							{
								...
								id: 'CCCNCCW_LpuSectionCombo',
								lastQuery: '',
								listWidth: 600,
								parentElementId: 'CCCNCCW_LpuBuildingCombo',
								width: 350,
								xtype: 'swlpusectionglobalcombo',
								listeners:{
									change: function(field, newValue){
										var lpuSection = me.FormPanel.getForm().findField('MedStaffFact_id');

										lpuSection.setDisabled(!newValue);
									}
								}
							},
							{
								...
								listeners: {
									focus: function(cb){
										...
										cb.baseFilterFn = setMedStaffFactGlobalStoreFilter({
											...
											LpuSection_id: me.FormPanel.getForm().findField('LpuSection_id').getValue()
										}, cb.store, true);
										if(!cb.store.getCount()) cb.clearValue()
									}.createDelegate(this),
									select: function(combo, record, index){
