/**
 * swCmpCallCardSimpleDrugEditWindow - окно редактирования информации об использовании медикаментов без учета остатков (простая форма)
 *
 ...
 * @author       Sysolin Maksim/Sobenin Alexander
 * @version      11.2017
 * @comment
 */
sw.Promed.swCmpCallCardSimpleDrugEditWindow = Ext.extend(sw.Promed.BaseForm, {

    id: 'CmpCallCardSimpleDrugEditWindow',
    autoHeight: false,
    layout: 'form',
    modal: true,
    resizable: false,
    ...
    // имя основной формы
    formName: 'CmpCallCardSimpleDrugEditForm',
    ...
    formPartiallyReset: function (){
        ...
        if (wnd.defaultSetDate) {
			form.findField('CmpCallCardDrug_setDate').setValue(wnd.defaultSetDate);
		}

		if (wnd.defaultSetTime) {
			form.findField('CmpCallCardDrug_setTime').setValue(wnd.defaultSetTime);
		}
    ...
    show: function() {
        ...
        sw.Promed.swCmpCallCardSimpleDrugEditWindow.superclass.show.apply(this, arguments);
        ...
        if (args.CmpCallCardDrug_setDate) {
			wnd.defaultSetDate = args.CmpCallCardDrug_setDate;
		}

		wnd.defaultSetTime = null;
		if (args.CmpCallCardDrug_setTime) {
			wnd.defaultSetTime = args.CmpCallCardDrug_setTime;
		}
        ...
        switch (wnd.action) {
            case 'add':
                ...
                if (args.EvnDrug_setDate) {
                    form.findField('CmpCallCardDrug_setDate').setValue(args.EvnDrug_setDate);
                }

                if (args.EvnDrug_setTime) {
                    form.findField('CmpCallCardDrug_setTime').setValue(args.EvnDrug_setTime);
                }
    ...
    initComponent: function() {
        ...
        sw.Promed.swCmpCallCardSimpleDrugEditWindow.superclass.initComponent.apply(this, arguments);
    }
});