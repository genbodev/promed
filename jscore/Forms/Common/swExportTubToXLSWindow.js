/**
 * swExportToFRBTWindow - окно экспорта данных в сервис ФРБТ
 *
...
sw.Promed.swExportTubToXLSWindow = Ext.extend(sw.Promed.BaseForm, {
	id: 'swExportTubToXLSWindow',
	width: 480,
	autoHeight: true,
	modal: true,
	noTaskBarButton: true,
	maximizable: true,
	title: 'Экспорт сведений в ФРБТ',
	...
	show: function() {
		sw.Promed.swExportTubToXLSWindow.superclass.show.apply(this, arguments);
	...
	initComponent: function() {
			...
			items: [
				{
					...
					fieldLabel: 'Условия включения сведений в файл экспорта',
					value: 3,
					...
					store: new Ext.data.SimpleStore({
						...
						data: [
							[1, 'Пациенты, добавленные в регистр'],
							[2, 'Пациенты, исключённые из регистра'],
							[3, 'Все']
						]
					})
				},
		...
		sw.Promed.swExportTubToXLSWindow.superclass.initComponent.apply(this, arguments);
	}
});