/**
 * swHighRiskPregnancyCardPrintWindow - окно печати карты отчета о наблюдении за беременными группы высокого риска
 *
...
sw.Promed.swHighRiskPregnancyCardPrintWindow = Ext.extend(sw.Promed.BaseForm, {
	id: 'swHighRiskPregnancyCardPrintWindow',
	width: 520,
	autoHeight: true,
	modal: true,
	title: 'Печать карты отчета о наблюдении за беременными группы высокого риска',
	...
	doPrint: function() {
		...
		printBirt({
			'Report_FileName': 'PregnScrn.rptdesign',
	...
	show: function() {
		sw.Promed.swHighRiskPregnancyCardPrintWindow.superclass.show.apply(this, arguments);
	...
	initComponent: function() {
		...
		sw.Promed.swHighRiskPregnancyCardPrintWindow.superclass.initComponent.apply(this, arguments);
	}
});