/**
 * swPersonPregnancyInterruptedWindow - окно просмотра регистра беременных
 *
...
sw.Promed.swPersonPregnancyInterruptedWindow = Ext.extend(sw.Promed.BaseForm, {
	buttonAlign: 'right',
	modal: true,
	layout: 'border',
	maximized: true,
	...
	width: 500,
	closeAction: 'hide',
	id: 'swPersonPregnancyInterruptedWindow',
	objectName: 'swPersonPregnancyInterruptedWindow',
	title: lang['abortyi'],
	plain: true,
	buttons: [
		'-',
	...
	show: function()
	{
		sw.Promed.swPersonPregnancyInterruptedWindow.superclass.show.apply(this, arguments);
	...
	initComponent: function()
	{
		...
		this.GridPanel = new sw.Promed.ViewFrame({
			...
			uniqueId: true,
			autoLoadData: false,
			dataUrl: '/?c=PersonPregnancy&m=loadInterruptedList',
			pageSize: 100,
			paging: true,
			root: 'data',
		...
		sw.Promed.swPersonPregnancyInterruptedWindow.superclass.initComponent.apply(this, arguments);
	}
});