/**
 * swHighRiskPregnancyHospPrintWindow - окно печати формы учета случаев госпитализации беременных высокого риска
 *
...
sw.Promed.swHighRiskPregnancyHospPrintWindow = Ext.extend(sw.Promed.BaseForm, {
	id: 'swHighRiskPregnancyHospPrintWindow',
	width: 500,
	autoHeight: true,
	modal: true,
	title: 'Печать формы учета случаев госпитализации беременных высокого риска',
	...
	doPrint: function() {
		...
		printBirt({
			'Report_FileName': 'HightRisk_Pregnancy_hosp.rptdesign',
	...
	show: function() {
		sw.Promed.swHighRiskPregnancyHospPrintWindow.superclass.show.apply(this, arguments);
	...
	initComponent: function() {
		...
		sw.Promed.swHighRiskPregnancyHospPrintWindow.superclass.initComponent.apply(this, arguments);
	}
});