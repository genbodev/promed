/**
* swPersonDopDispPlanImportWindow - окно импорта данных плана профилактического мероприятия
*
...
sw.Promed.swPersonDopDispPlanImportWindow = Ext.extend(sw.Promed.BaseForm, {
	autoHeight: true,
	buttonAlign: 'left',
	modal: true,
	closable: true,
	closeAction: 'hide',
	draggable: false,
	id: 'swPersonDopDispPlanImportWindow',
	title: 'Импорт данных плана профилактического мероприятия',
	width: 400,
	//layout: 'form',
	resizable: false,
	plain: true,
	initComponent: function()
	{
		...
		this.TextPanel = new Ext.FormPanel({
			...
			id: 'ImportTextPanel',
			labelWidth: 50,
			url: '/?c=PersonDopDispPlan&m=importPersonDopDispPlan',
		...
		sw.Promed.swPersonDopDispPlanImportWindow.superclass.initComponent.apply(this, arguments);
	},
	doSave: function()
	{
	...
	show: function()
	{
		sw.Promed.swPersonDopDispPlanImportWindow.superclass.show.apply(this, arguments);
		var win = this;
		win.buttons[0].enable();
