...
sw.Promed.swPersonCardAttachListWindow = Ext.extend(sw.Promed.BaseForm, {
	...
	show: function()
	{
		...
		this.GridPanel.setReadOnly(this.viewOnly);
		...
		this.GridPanel.setActionDisabled('action_addPersonCard', this.viewOnly);
		this.GridPanel.setActionDisabled('action_changestatus', this.viewOnly);
	...
	initComponent: function()
	{
		...
		this.GridPanel = new sw.Promed.ViewFrame({
			...
			onRowSelect: function(sm, index, record) {
				...
				this.setActionDisabled('action_edit', wnd.viewOnly || HasPersonCard);
				this.setActionDisabled('action_delete', wnd.viewOnly || HasPersonCard);
				/*if(!HasPersonCard)
				{
