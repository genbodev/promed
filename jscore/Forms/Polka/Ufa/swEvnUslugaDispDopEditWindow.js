...
sw.Promed.swEvnUslugaDispDopEditWindow = Ext.extend(sw.Promed.BaseForm, {
	...
	doSave: function() {
		...
		if ( current_window.findById('EUDDEW_EvnUslugaDispDop_setDate').getValue() > current_window.findById('EUDDEW_EvnUslugaDispDop_didDate').getValue() )
		{
            Ext.MessageBox.show({
                ...
                icon: Ext.Msg.WARNING,
                msg: 'Дата исследования не может превышать дату получения результата.',
                title: 'Ошибка'
            });
            return false;
		}
		...
		if ( ( set_date.getMonthsBetween(did_date) > 3 ) || ( set_date.getMonthsBetween(did_date) == 3 && (set_date.getDate() != did_date.getDate()) ) )
		{
			Ext.MessageBox.show({
                ...
                icon: Ext.Msg.WARNING,
                msg: 'Дата получения результата" лабораторного исследования не более 3-х месяцев с даты исследования.',
                title: 'Ошибка'
            });
            return false;
		}
		...
		if ( pl_set_date > set_date && (usluga_type_id == 6 || usluga_type_id == 5) )
		{
			if ( ( set_date.getMonthsBetween(pl_set_date) > 24 ) || ( set_date.getMonthsBetween(pl_set_date) == 24 && (set_date.getDate() != pl_set_date.getDate()) ) )
			{
				Ext.MessageBox.show({
					...
					icon: Ext.Msg.WARNING,
					msg: 'Давность этого исследования не может быть более 2х лет.',
					title: 'Ошибка'
				});
				return false;
			}
		...
		if ( pl_set_date > set_date && usluga_type_id != 6 && usluga_type_id != 5 )
		{
			if ( ( set_date.getMonthsBetween(pl_set_date) > 3 ) || ( set_date.getMonthsBetween(pl_set_date) == 3 && (set_date.getDate() != pl_set_date.getDate()) ) )
			{
				Ext.MessageBox.show({
					...
					icon: Ext.Msg.WARNING,
					msg: 'Давность этого исследования не может быть более 3х месяцев.',
					title: 'Ошибка'
				});
				return false;
			}
		...
		*/
		...
		else 
		{
			...
			sw.swMsg.alert('Ошибка', 'Необходимо выбрать соответсвующую услугу!', function() { current_window.findById('EUDDEW_UslugaCombo').focus(); } );
			return false;
		}
					...
					}, 
					{
						...
						listeners: {
							'beforequery': function(event) {
								...
								if (!usluga_date)
								{
									sw.swMsg.alert('Ошибка', 'Вы не указали дату выполнения услуги!', function() { usluga_date_field.focus(); } );
									return false;
								}
	...
	setDopDispUslugaTypeFilter: function() {
		...
		dopdispuslugatype_combo.getStore().filterBy(function(record) {
			...
			{
				if ( dopdispuslugatype_combo.getValue() == 8 )
					return true;
				else
					return false;
			}
			if (
				( record.data.DopDispUslugaType_id == 1 && !((soc_status_id == 1 || soc_status_id == 8) && age > 17) )
				|| ( record.data.DopDispUslugaType_id == 2 && !((soc_status_id == 1 || soc_status_id == 8) && age > 17) )
				|| ( record.data.DopDispUslugaType_id == 3 && (soc_status_id != 1 && soc_status_id != 8 && age > 17) )				
				|| ( record.data.DopDispUslugaType_id == 4 && (soc_status_id != 1 && soc_status_id != 8 && age > 17) )
				|| ( record.data.DopDispUslugaType_id == 5 && (current_window.EvnPLDispDop_IsNotMammograf == true || !(sex_id == 2 && age >= 40 && (soc_status_id == 1 || soc_status_id == 8))) )
				|| ( record.data.DopDispUslugaType_id == 6 && !((soc_status_id == 1 || soc_status_id == 8) && age > 17) )
				|| ( record.data.DopDispUslugaType_id == 7 && (soc_status_id != 1 && soc_status_id != 8 && age > 17) )
				|| ( record.data.DopDispUslugaType_id == 9 && !((soc_status_id == 1 || soc_status_id == 8) && age > 17) )
				|| ( record.data.DopDispUslugaType_id == 10 && !((soc_status_id == 1 || soc_status_id == 8) && age > 17) )
				|| ( record.data.DopDispUslugaType_id == 11 && !(sex_id == 2 && age >= 45 && (soc_status_id == 1 || soc_status_id == 8)) )
				|| ( record.data.DopDispUslugaType_id == 12 && !(sex_id == 1 && age >= 45 && (soc_status_id == 1 || soc_status_id == 8)) )
				|| ( record.data.DopDispUslugaType_id == 13 && !((soc_status_id == 1 || soc_status_id == 8) && age > 17) )
				|| ( record.data.DopDispUslugaType_id == 14 && !((soc_status_id == 1 || soc_status_id == 8) && age > 17) )
				|| ( record.data.DopDispUslugaType_id == 15 && !((soc_status_id == 1 || soc_status_id == 8) && age > 17) )
				|| ( record.data.DopDispUslugaType_id == 16 && !((soc_status_id == 1 || soc_status_id == 8) && age > 17) )
				|| ( record.data.DopDispUslugaType_id == 17 && !((soc_status_id == 1 || soc_status_id == 8) && age > 17) )
				|| ( record.data.DopDispUslugaType_id == 18 && (current_window.EvnPLDispDop_IsNotCito == true || !(sex_id == 2 && (soc_status_id == 1 || soc_status_id == 8))) )
				|| ( record.data.DopDispUslugaType_id == 19 && age > 17 )
				|| ( record.data.DopDispUslugaType_id == 20 && age > 17 )
				|| ( record.data.DopDispUslugaType_id == 21 && age > 0 )
				|| ( record.data.DopDispUslugaType_id == 22 && age > 17 )
			)
				return false;
    ...
    show: function() {
        ...
        {
        	Ext.Msg.alert('Сообщение', 'Неверные параметры', function() { current_window.hide(); } );
        	return false;
        }
		...
		if (lpu_section_combo.getStore().getCount() == 0)
		{
			lpu_section_combo.getStore().load({
				callback: function(records, options, success) {
					if (!success)
					{
						Ext.Msg.alert('Ошибка', 'Ошибка при загрузке справочника отделений (Посещение)');
						return false;
					}
		...
		if (med_personal_combo.getStore().getCount() == 0)
		{
			med_personal_combo.getStore().load({
				callback: function(records, options, success) {
					if (!success)
					{
						Ext.Msg.alert('Ошибка', 'Ошибка при загрузке мед. персонала (Посещение)');
						return false;
					}
        ...
        {
            case 'add':
                current_window.setTitle('Лабораторное исследование: Добавление');
        	...
        	case 'edit':
        	    current_window.setTitle('Лабораторное исследование: Редактирование');
                current_window.enableEdit(true);
            ...
            case 'view':
                current_window.setTitle('Лабораторное исследование: Просмотр');
