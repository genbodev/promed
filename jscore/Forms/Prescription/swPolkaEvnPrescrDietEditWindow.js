/**
 * swPolkaEvnPrescrDietEditWindow - окно добавления/редактирования назначения c типом Диета.
 *
...
sw.Promed.swPolkaEvnPrescrDietEditWindow = Ext.extend(sw.Promed.BaseForm, {
    codeRefresh: true,
    objectName: 'swPolkaEvnPrescrDietEditWindow',
    objectSrc: '/jscore/Forms/Prescription/swPolkaEvnPrescrDietEditWindow.js',
    ...
    draggable: true,
    formStatus: 'edit',
    id: 'PolkaEvnPrescrDietEditWindow',
    layout: 'form',
    listeners: {
        hide: function(win) {
            win.onHide();
    ...
    doSave: function(options) {
		...
		base_form.findField('PrescriptionDietType_id').enable();
    ...
    initComponent: function() {
        ...
        Ext.apply(this, {
            buttons: [{
                ...
                iconCls: 'cancel16',
				tabIndex:TABINDEX_PEDEW+6,
                text: BTN_FRMCANCEL,
				onTabAction: function () {
                      thas.FormPanel.getForm().findField('PrescriptionDietType_id').focus(true, 250);
                    }
                /*}, {
                 handler: function() {
        ...
        sw.Promed.swPolkaEvnPrescrDietEditWindow.superclass.initComponent.apply(this, arguments);
    },
    show: function() {
        sw.Promed.swPolkaEvnPrescrDietEditWindow.superclass.show.apply(this, arguments);
        var thas = this;
        this.center();
		...
		if(arguments[0].begDate && typeof arguments[0].begDate == 'string'){
        ...
        switch ( this.action ) {
            case 'add':
                ...
                this.setTitle(lang['naznachenie_dietyi_dobavlenie']);
                this.setFieldsDisabled(false);
				if(arguments[0].formParams.PrescriptionDietType_id){
					 base_form.findField('PrescriptionDietType_id').disable();
				}
            ...
            case 'view':
                base_form.load({
                    ...
                    success: function() {
                        ...
                        if ( thas.action == 'edit' ) {
                            thas.setTitle(lang['naznachenie_dietyi_redaktirovanie']);
                            thas.setFieldsDisabled(false);
                        }
                        else {
                            thas.setTitle(lang['naznachenie_dietyi_prosmotr']);
