...
sw.Promed.swEvnPrescrTreatDrugEditWindow = Ext.extend(sw.Promed.BaseForm, {
	...
	doSave: function() {
		...
		var record = base_form.findField('Drug_id').getStore().getAt(index);

		if ( record ) {
			drug_name = record.get('Drug_Name');
		}

		evnPrescrTreatDrugData.Drug_id = drug_id;
		evnPrescrTreatDrugData.Drug_Name = drug_name;
		evnPrescrTreatDrugData.DrugPrepFas_id = base_form.findField('DrugPrepFas_id').getValue();
