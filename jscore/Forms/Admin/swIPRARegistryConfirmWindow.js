...
sw.Promed.swIPRARegistryConfirmWindow = Ext.extend(sw.Promed.BaseForm, {
	...
	objectSrc: '/jscore/Forms/Admin/swIPRARegistryConfirmWindow.js',
	layout: 'form',
	...
	listeners: {
		'hide': function() {
			Ext.getCmp('ipra_tab_panel').setActiveTab(0);
			Ext.getCmp('formIPRA').getForm().reset();
			Ext.getCmp('swIPRARegistryConfirmWindow').enableEdit(true);
			delete this.action;
			delete this.editErrors;
		}
	},
	...
	forms_setDisabled: function(value){
			...
			'-',
			{
				...
				handler: function () {
					...
					if (Ext.getCmp('formIPRA').getForm().isValid()) {
						...
						data_params.IPRARegistry_Number = Ext.getCmp('formIPRA').getForm().findField('IPRARegistry_Number').getValue();
						data_params.IPRARegistry_isFirst = Ext.getCmp('formIPRA').getForm().findField('IPRARegistry_isFirst').getValue();
						data_params.IPRARegistry_Protocol = Ext.getCmp('formIPRA').getForm().findField('IPRARegistry_Protocol').getValue();
						...
						data_params.IPRARegistryData_DisabilityGroup = Ext.getCmp('formIPRA').getForm().findField('IPRARegistryData_DisabilityGroup').getValue();
						data_params.IPRARegistryData_IsDisabilityGroupPrimary = Ext.getCmp('formIPRA').getForm().findField('IPRARegistryData_IsDisabilityGroupPrimary').getValue();
						data_params.IPRARegistryData_IsIntramural = Ext.getCmp('formIPRA').getForm().findField('IPRARegistryData_IsIntramural').getValue();
						data_params.IPRARegistryData_RehabPotential = Ext.getCmp('formIPRA').getForm().findField('IPRARegistryData_RehabPotential').getValue();
						data_params.IPRARegistryData_RehabPrognoz = Ext.getCmp('formIPRA').getForm().findField('IPRARegistryData_RehabPrognoz').getValue();
						data_params.IPRARegistryData_PrognozResult_SelfService = Ext.getCmp('formIPRA').getForm().findField('IPRARegistryData_PrognozResult_SelfService').getValue();
						data_params.IPRARegistryData_PrognozResult_Independently = Ext.getCmp('formIPRA').getForm().findField('IPRARegistryData_PrognozResult_Independently').getValue();
						data_params.IPRARegistryData_PrognozResult_Orientate = Ext.getCmp('formIPRA').getForm().findField('IPRARegistryData_PrognozResult_Orientate').getValue();
						data_params.IPRARegistryData_PrognozResult_Communicate = Ext.getCmp('formIPRA').getForm().findField('IPRARegistryData_PrognozResult_Communicate').getValue();
						data_params.IPRARegistryData_PrognozResult_BehaviorControl = Ext.getCmp('formIPRA').getForm().findField('IPRARegistryData_PrognozResult_BehaviorControl').getValue();
						data_params.IPRARegistryData_PrognozResult_Learning = Ext.getCmp('formIPRA').getForm().findField('IPRARegistryData_PrognozResult_Learning').getValue();
						data_params.IPRARegistryData_PrognozResult_Work = Ext.getCmp('formIPRA').getForm().findField('IPRARegistryData_PrognozResult_Work').getValue();
						...
						items: [{
							...
							items: [{
								...
								items: [{
									...
									listeners: {
										'valid': function() {
											Ext.getCmp('IPRARegistryData_DisabilityEndDate').validate();
										}
									}
								}, {
									layout: 'column',
									...
									items: [{
										...
										items: [{
											...
											validator: function () {
												...
												var indefinitely = base_form.findField('checkbox_DisEndDate').getValue();
												if (!indefinitely && ((Ext.isEmpty(begDate) && !Ext.isEmpty(endDate)) || begDate > endDate)) {
													return false;
												} else {
													return true;
												}
	...
	show: function (params) {
...

		{
			...
			grid_IPRA.getStore().on(
					'load', function () {
						var rowIndex = this.find('IPRARegistry_id', params.IPRARegistry_id);
		...
		Ext.Ajax.request({
			...
			callback: function (options, success, response) {
				if (success) {
					...
					if (
						Ext.getCmp('formIPRA').getForm().findField('IPRARegistry_Confirm').getValue()
