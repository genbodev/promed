...
sw.Promed.AdminBSKRecomendationWindow = Ext.extend(sw.Promed.BaseForm,
{
    title: 'Рекомендации',
	...
	frame: true,
    buttonAlign: "left",
	objectName: 'AdminBSKRecomendationWindow',
	id: 'AdminBSKRecomendationWindow',
	objectSrc: '/jscore/Forms/Admin/AdminBSKRecomendationWindow.js',
	...
	{   
          ...
          this.gridRecomendation = new sw.Promed.ViewFrame({
            			...
            			dataUrl: '/?c=BSK_Register&m=getRecomendations',
            			autoLoadData: false,
                              ...
                              items : [
                                {
                                    ...
                                    handler: function(){
                                         ...
                                         var params = { 
                                                BSKObservRecomendationType_id: Ext.getCmp('AdminBSKRecomendationWindow').params.Type,
                                                searchRecomendation_text: searchRecomendation_text,
                                                BSKObservElementValues_id : Ext.getCmp('AdminBSKRecomendationWindow').params.Value,
                                         }                   
                                         ...
                                         Ext.getCmp('AdminBSKRecomendationWindow').checkedRecomendation(params, false);
            ...
            [
            
                {
                  ...
                  handler: function(){
                    ...
                    var sel = Ext.getCmp('AdminBSKRecomendationWindow').gridRecomendation.getGrid().getSelectionModel().getSelections();
                    ...
                    var BSKObservElementValues_id = Ext.getCmp('AdminBSKViewForm').GridValues.getGrid().getSelectionModel().getSelected().data.BSKObservElementValues_id;
                    var jsonSetRecomendation = Ext.util.JSON.encode(setRecomendation);
                    var BSKObservRecomendationType_id = Ext.getCmp('AdminBSKRecomendationWindow').params.Type;
                    
                    //console.log('setRecomendation: ', jsonSetRecomendation);
                    
                            Ext.Ajax.request({
                		 		url: '/?c=BSK_Register&m=saveRecomendation',
                				params: { 
        ...
        Ext.getCmp('AdminBSKRecomendationWindow').gridRecomendation.getGrid().getStore().load(
            {
                ...
                callback : function(){
                    ...
                    Ext.getCmp('AdminBSKRecomendationWindow').gridRecomendation.getGrid().getSelectionModel().deselectRange(0,100);
                    ...
                    for(k in rstore.data.items){
                        if(typeof rstore.data.items[k] == 'object'){
                            ...
                            if(rec.data.mark == 1 && Ext.getCmp('AdminBSKRecomendationWindow').params.Type == rec.data.BSKObservRecomendationType_id){
                                //console.log('MARK: ', rec.data.mark, 'TYPE_ID: ', rec.data.BSKObservRecomendationType_id,'/', Ext.getCmp('AdminBSKRecomendationWindow').params.Type, 'VAL_ID: ', BSKObservElementValues_id);
                                //console.log('YES: ',  rec);
...
<pre>
\jscore\Forms\Admin\Ufa\personBskRegistryWindow.js
\jscore\Forms\Common\swBskRegistryWindow.js
\promed\models\Bsk_Register_User_model.php
</pre>
*/ 