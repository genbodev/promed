/**
 * swLpuBuildingOfficeMedStaffLinkPrintWindow - параметры печати
 *
 ...
 * @version     12.2017
 */
sw.Promed.swLpuBuildingOfficeMedStaffLinkPrintWindow = Ext.extend(sw.Promed.BaseForm, {
	/* свойства */
	autoHeight: true,
	id: 'swLpuBuildingOfficeMedStaffLinkPrintWindow',
	layout: 'form',
	maximizable: false,
	modal: true,
	resizable: false,
	...
	doPrint: function() {
		...
		var paramLpu = base_form.findField('Lpu_id').getValue();
	...
	show: function() {
		sw.Promed.swLpuBuildingOfficeMedStaffLinkPrintWindow.superclass.show.apply(this, arguments);
	...
	initComponent: function() {
		...
		this.FormPanel = new Ext.FormPanel({
			...
			url: '/?c=LpuBuildingOfficeMedStaffLink&m=print'
		});
		...
		sw.Promed.swLpuBuildingOfficeMedStaffLinkPrintWindow.superclass.initComponent.apply(this, arguments);
	}
});