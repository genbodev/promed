...
sw.Promed.swIPRARegistryEditWindow = Ext.extend(sw.Promed.BaseForm, {
	...
	objectSrc: '/jscore/Forms/Admin/swIPRARegistryEditWindow.js',
	layout: 'form',
	...
	listeners: {
		'hide': function() {
			Ext.getCmp('ipra_tab_panel_edit').setActiveTab(0);
													...
													items:[
													{
														...
														items: [
															...
															},
															{
																...
																listeners: {
																	'valid': function() {
																		Ext.getCmp('IPRAData_DisabilityEndDate').validate();
																	}
																}
															},
															{
																		...
																		items: [
																			{
																				...
																				validator: function () {
																					...
																					var indefinitely = base_form.findField('checkbox_DisEndDate_edit').getValue();
