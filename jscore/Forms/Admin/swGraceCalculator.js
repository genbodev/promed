/**
* swGraceCalculator - окно для калькулятора Grace.
*  
*
...
sw.Promed.swGraceCalculator = Ext.extend(sw.Promed.BaseForm, {
    alwaysOnTop: true,
	id    : 'swGraceCalculator', 
	objectName    : 'swGraceCalculator',
	objectSrc     : '/jscore/Forms/Admin/swGraceCalculator.js',    
	layout: 'form',
	buttonAlign: 'center',
	...
	{      
			...
			buttons : [
					 {
						...
						handler: function() 
						{
                            ...
                            if (summ < 109) {
								...
								form.value_id = 717;//значение из справочника BSKObservElementValues
                            } 
                            else if (summ <= 140) {
                     ...
                     {	
						...
						handler: function() {
                            if (form.items.get(9).getValue()>'') {
                                ...
                                Ext.getCmp('PBRW_Answer_269').setValue(form.value_id);
                                form.refresh();
                            }
						},
						iconCls: 'ok16',
		...
		sw.Promed.swGraceCalculator.superclass.initComponent.apply(this, arguments);
	},
	refresh : function(){
	...
	{   
            console.log(params);
            if (typeof Ext.getCmp('PBRW_Answer_269') != 'undefined'){
                Ext.getCmp('PBRW_Answer_269').collapse();
            }
            ...
            sw.Promed.swGraceCalculator.superclass.show.apply(this, arguments);
	}
