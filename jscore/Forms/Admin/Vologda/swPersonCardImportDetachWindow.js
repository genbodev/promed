/**
 * swPersonCardImportDetachWindow - окно импорта сведений о ЗЛ, открепленных от МО
 *
...
sw.Promed.swPersonCardImportDetachWindow = Ext.extend(sw.Promed.BaseForm, {
	id: 'swPersonCardImportDetachWindow',
	maximizable: false,
	resizable: false,
	modal: true,
	autoHeight: true,
	width: 450,
	layout: 'form',
	title: 'Импорт сведений о ЗЛ, открепленных от МО',

	doImport: function() {
		var wnd = this;
		var baseForm = wnd.FormPanel.getForm();
		var importButton = Ext.getCmp('PCIDW_ImportButton');
	...
	show: function() {
		...
		sw.Promed.swPersonCardImportDetachWindow.superclass.show.apply(wnd, arguments);
	...
	initComponent: function() {
		...
		wnd.FormPanel = new Ext.form.FormPanel({
			...
			labelWidth: 40,
			fileUpload: true,
			url: '/?c=PersonCard&m=importPersonCardDetach',
			items: [{
				allowBlank: false,
		...
		sw.Promed.swPersonCardImportDetachWindow.superclass.initComponent.apply(wnd, arguments);
	}
});