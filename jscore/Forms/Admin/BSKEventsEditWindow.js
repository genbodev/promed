/**
* BSKEventsEditWindow - окно для добавления событий пациенту в регистре БСК.
*  
*
...
sw.Promed.BSKEventsEditWindow = Ext.extend(sw.Promed.BaseForm, {
    //alwaysOnTop: true,
	id    : 'BSKEventsEditWindow', 
	objectName    : 'BSKEventsEditWindow',
	objectSrc     : '/jscore/Forms/Admin/Ufa/BSKEventsEditWindow.js',    
	layout: 'form',
	//plain: true,    
	...
	{   
			...
			buttons : [
				{ text:'Сохранить', iconCls: 'save16', 
				  handler: function(){
                                ...
                                var UslugaComplexCombo = Ext.getCmp('comboUslugaComplex_id_edit');
                                ...
                                Ext.Ajax.request({
                    		 		url: '/?c=BSK_Register_User&m=saveEvent',
                    				params: {
                    				    BSKEvents_Type : EventType,
                                        BSKEvents_id : Ext.getCmp('BSKEventsEditWindow').Events_id,
                    				...
                    				callback: function(options, success, response) {
                    				     ...
                    				     if(success === true){
                    				         Ext.getCmp('BSKEventsEditWindow').refresh();  
                                             //Ext.getCmp('BSKEventsEditWindow').showMsg('Событие успешно сохранено!');
                                            ...
                                            Ext.getCmp('BSKEventsEditWindow').showMsg('Произошла ошибка при попытки сохранения события!');
                                         }
                                    }
                                });   
                        ...
                        listeners : {
                            ...
                            'select' : function(){
                                if(this.getValue() == 'Диагноз'){
                                    ...
                                    Ext.getCmp('comboUslugaComplex_id_edit').ownerCt.hide();
                                }
                                else{
                                    Ext.getCmp('comboDiag_id_edit').ownerCt.hide();
                                    Ext.getCmp('comboUslugaComplex_id_edit').ownerCt.show();                                    
                                }
                        ...
                        listeners : {
                            'blur' : function(){
                                if(new Date(this.getValue()) > new Date()){
                                    Ext.getCmp('BSKEventsEditWindow').showMsg('Указана не корректная дата события');
		...
		sw.Promed.BSKEventsEditWindow.superclass.initComponent.apply(this, arguments);
	},
	...
	{      
            ...
            this.findById('comboUslugaComplex_id_edit').setUslugaCategoryList([ 'gost2011' ]);;

            if(arguments[0].params.Events_Type == 'Услуга'){
                var id_EventName_edit = 'comboUslugaComplex_id_edit';
                this.findById('comboUslugaComplex_id_edit').ownerCt.setVisible(true);
                ...
                this.findById('comboUslugaComplex_id_edit').ownerCt.setVisible(false);
            }
            ...
            sw.Promed.BSKEventsEditWindow.superclass.show.apply(this, arguments);
