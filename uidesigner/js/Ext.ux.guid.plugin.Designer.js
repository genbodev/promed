...
Ext.extend(Ext.ux.guid.plugin.Designer, Ext.ux.Json, {
 ...
 //Menu buttons
  ...
  init: function(field) {
	...
	// в родительском контейнере создаем ссылку на себя
	if ( this.mainContainerId )
		Ext.getCmp(this.mainContainerId).designPlugin = this;
