...
/**
* Krym_EvnPLDispDop13_model - модель для работы с талонами по диспансеризации взрослого населения (Крым)
*
...
class Krym_EvnPLDispDop13_model extends EvnPLDispDop13_model
{
	/**
	 *	Конструктор
	 */	
