 ...
 */
class EvnNotifyHIVDisp_model extends swModel
{
	/**
	 * Конструктор
	 */
	...
	function load($data)
	{
		$query = '
			select
				...
				ENO.EvnNotifyHIVDisp_pid,
				ENO.Morbus_id,
				ENO.Server_id,
				ENO.PersonEvn_id,
				ENO.Person_id,
				convert(varchar,ENO.EvnNotifyHIVDisp_setDT,104) as EvnNotifyHIVDisp_setDT,
				ENO.MedPersonal_id,
				...
				ENO.Person_mid,
				ENO.EvnNotifyHIVDisp_IsRefuse,
				ENO.HIVChildType_id,
				ENO.EvnNotifyHIVDisp_OtherChild,
				ENO.EvnNotifyHIVDisp_Place,
				convert(varchar,ENO.EvnNotifyHIVDisp_DiagDT,104) as EvnNotifyHIVDisp_DiagDT,
				ENO.EvnNotifyHIVDisp_Diag,
				ENO.EvnNotifyHIVDisp_CountCD4,
				ENO.EvnNotifyHIVDisp_PartCD4,
			...
			from
				v_EvnNotifyHIVDisp ENO with (nolock)
				...
				left join v_MorbusHIVLab lab with (nolock) on ENO.EvnNotifyHIVDisp_id = lab.EvnNotifyBase_id and lab.MorbusHIV_id is null
			where
				ENO.EvnNotifyHIVDisp_id = ?
		';
		...
		try {
			...
			$queryEvnNotifyHIVDisp = '
				declare
					...
					@ErrCode bigint,
					@ErrMsg varchar(4000);
				set @Res = :EvnNotifyHIVDisp_id;
				exec p_EvnNotifyHIVDisp_' . $procedure_action . '
					@EvnNotifyHIVDisp_id = @Res output,
				...
				select @Res as EvnNotifyHIVDisp_id, @ErrCode as Error_Code, @ErrMsg as Error_Msg;
			';
			// Стартуем транзакцию
	...
	function del($data)
	{
		$query = '
			declare
				...
				@ErrMsg varchar(4000);
			set @Res = :EvnNotifyHIVDisp_id;
			exec p_EvnNotifyHIVDisp_del
				@EvnNotifyHIVDisp_id = @Res,
				@pmUser_id = :pmUser_id,
				@Error_Code = @ErrCode output,
				@Error_Message = @ErrMsg output;
			select @Res as EvnNotifyHIVDisp_id, @ErrCode as Error_Code, @ErrMsg as Error_Msg;
