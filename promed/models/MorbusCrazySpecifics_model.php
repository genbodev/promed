...
require_once 'Morbus_model.php';
require_once 'MorbusCrazy_model.php';
require_once 'MorbusBase_model.php';
require_once 'MorbusCrazySection_model.php';
require_once 'MorbusCrazySpecifics_model.php';
require_once 'MorbusCrazyPerson_model.php';
...
class MorbusCrazySpecifics_model extends Abstract_model
{
    ...
    function __construct()
    {
        ...
        $this->MorbusCrazyPerson = new MorbusCrazyPerson_model();
        $this->MorbusCrazyDrug = new Collection_model();
        $this->MorbusCrazyDrug->setTableName('MorbusCrazyDrug');
        $this->MorbusCrazyDrug->setInputRules(array(
            array('field'=>'MorbusCrazyDrug_id'    ,'label' => 'Идентификатор Употребление психоактивных веществ на момент госпитализации','rules' => '', 'type' => 'int'),//  Идентификатор Употребление психоактивных веществ на момент госпитализации
            array('field'=>'MorbusCrazyBase_id' ,'label' => 'Специфика общего психического/наркологического заболевания','rules' => 'required', 'type' => 'id'),//  Специфика движения
            array('field'=>'MorbusCrazySection_id' ,'label' => 'Специфика движения','rules' => 'required', 'type' => 'id'),//  Специфика движения
            array('field'=>'MorbusCrazyDrug_Name'  ,'label' => 'Наименование','rules' => 'required', 'type' => 'string'),//  Наименование
            array('field'=>'CrazyDrugType_id'      ,'label' => 'Вид вещества','rules' => '', 'type' => 'int'),//  Вид вещества
            array('field'=>'CrazyDrugReceptType_id','label' => 'Тип приема','rules' => '', 'type' => 'int'),//  Тип приема
