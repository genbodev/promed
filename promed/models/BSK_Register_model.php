...
class BSK_Register_model extends swModel
{
    ...
    public function listRecomendation($data)
    {
        ...
        $query = "
            select 
             ...
             from dbo.BSKObservRecomendation with(nolock)
    ...
    function getRecomendations($data)
    {
        ...
        $query = "
            ...
            as mark
            from dbo.BSKObservRecomendation R with(nolock)
            left join dbo.BSKObservRecomendationLink RL with(nolock) on R.BSKObservRecomendation_id = RL.BSKObservRecomendation_id and RL.BSKObservRecomendationLink_deleted = 1
            left join  dbo.BSKObservElementValues L with(nolock) on RL.BSKObservElementValues_id = L.BSKObservElementValues_id
            left join dbo.BSKObservRecomendationType RT with(nolock) on RT.BSKObservRecomendationType_id = R.BSKObservRecomendationType_id
    ...
    function deleteRecomendation($data)
    {
        ...
        $query = "
                 ...
                 and BSKObservRecomendation_id in(
                    select 
                    	R.BSKObservRecomendation_id
                    from dbo.BSKObservRecomendationLink  RL with(nolock)
                    left join dbo.BSKObservRecomendation R with(nolock) on R.BSKObservRecomendation_id = RL.BSKObservRecomendation_id
        ...
        */
		$query = "
			...
			exec dbo.p_BSKObservRecomendationLink_del
    ...
    function deleteEditRecomendation($data)
    {
        ...
        */
		$query = "
			...
			exec dbo.p_BSKEditRecomendation_del
    ...
    function saveAfterEditRecomendation($data)
    {
        ...
        */
		$query = "
			...
			exec dbo.p_BSKEditRecomendation_upd
    ...
    function preSaveRecomendation($data)
    {
        ...
        $query = "
            ...
            if((select count(BSKObservRecomendationLink_id) from dbo.BSKObservRecomendationLink with(nolock) where BSKObservElementValues_id = :BSKObservElementValues_id and BSKObservRecomendation_id = :BSKObservRecomendation_id) = 0)
            begin
                                  
        		exec dbo.p_BSKPreRecomendation_ins
        			@BSKObservRecomendation_id = :BSKObservRecomendation_id,
                    @BSKObservElementValues_id = :BSKObservElementValues_id,
        			@pmUser_id = :pmUser_id,
        			@Error_Code = @ErrCode output,
        		...
        		exec dbo.p_BSKPreRecomendation_upd
        			@BSKObservRecomendation_id = :BSKObservRecomendation_id,
                    @BSKObservElementValues_id = :BSKObservElementValues_id,
        			@pmUser_id = :pmUser_id,
        			@Error_Code = @ErrCode output,
    ...
    function addRecomendation($data)
    {
        ...
        $query = "
    		...
    		exec dbo.p_BSKRecomendation_ins
    			@BSKObservRecomendation_text = :BSKObservRecomendation_text,
                @BSKObservRecomendationType_id = :BSKObservRecomendationType_id,
    			@pmUser_id = :pmUser_id,
    			@Error_Code = @ErrCode output,
    ...
    function getLinks()
    {
        ...
        $query = "select 
                 BSKObservElement_id,
                 BSKObject_id
                from dbo.BSKObservElementLink with(nolock)
            ...
            $query = "
                ...
                if (select 
                	...
                	begin
                		...
                		exec dbo.p_BSKObservElementLink_upd
            		...
            		exec dbo.p_BSKObservElementLinkAdd_ins
                        @BSKObservElement_id = :BSKObservElement_id,
                        @BSKObject_id = :BSKObject_id,
                        @BSKObservElementLink_deleted = @BSKObservElementLink_deleted,
            			@pmUser_id = :pmUser_id,
    ...
    function getListObjects($data)
    {
        ...
        $query = "
            select 
               ...
               M.MorbusType_id,
               M.MorbusType_name
            from dbo.v_BSKObject O with(nolock)
            inner join dbo.MorbusType M with(nolock) on M.MorbusType_id = O.MorbusType_id   
	...
	function getListFormTemplate($data)
	{
		...
		//select * from dbo.BSKObservElementGroup with(nolock)
		$query  = "
			select 
				BSKRegistryFormTemplate_id, 
				convert(varchar(10),BSKRegistryFormTemplate_BegDT, 105)+'-'+ISNULL(convert(varchar(10),BSKRegistryFormTemplate_EndDT, 105),convert(varchar(10),GETDATE(), 105)) BSKRegistryFormTemplate_name
			from 
    ...
    function getListGroupTypes($data)
    {
        ...
        $query  = "
            select 
              Gr.BSKObservElementGroup_id , 
              Gr.BSKObservElementGroup_name    
            from 
              {$this->scheme}.BSKObservElementGroup Gr with (nolock)
			  cross apply (select distinct td.BSKObservElementGroup_id, td.BSKRegistryFormTemplateData_GroupNum
				  from dbo.BSKRegistryFormTemplateData td with (nolock)
				  where td.BSKObservElementGroup_id = GR.BSKObservElementGroup_id
				  and td.BSKRegistryFormTemplate_id = :BSKRegistryFormTemplate_id) td
            where
              BSKObject_id = :BSKObject_id
              and
        ...
        $query = "
            select 
                ...
                (select 
    			 ...
    			 from dbo.BSKObservElementFormat with(nolock)
            ...
            --left join /*{$this->scheme}*/dbo.BSKObservElementLink EL with (nolock) on EL.BSKObservElement_id = E.BSKObservElement_id 
			inner join dbo.BSKRegistryFormTemplateData TD with (nolock) on TD.BSKObservElement_id = E.BSKObservElement_id 
			inner join dbo.BSKRegistryFormTemplate FT with (nolock) on FT.BSKRegistryFormTemplate_id = TD.BSKRegistryFormTemplate_id 
				and TD.BSKRegistryFormTemplate_id = :BSKRegistryFormTemplate_id
			left join v_Unit Unit with (nolock) on Unit.Unit_id = E.Unit_id
			left join dbo.BSKObservDict Dict with (nolock) on Dict.BSKObservDict_id = E.BSKObservDict_id
			...
			order by TD.BSKRegistryFormTemplateData_ElementNum
        ";
    ...
    function getListValues($data)
    {
        ...
        $query = "
           select 
              ...
              ES.BSKObservElementSign_name BSKObservElementValues_sign,
              BSKObservElementValues_data
           from
             {$this->scheme}.BSKObservElementValues EV with (nolock)
			 left join dbo.BSKObservElementSign ES with (nolock) on ES.BSKObservElementSign_id = EV.BSKObservElementSign_id
           where
              BSKObservElement_id = :BSKObservElement_id  
              and
    ...
    function addGroupType($data)
    {
        ...
        */
		$query = "
			...
			exec dbo.p_BSKObservElementGroup_ins
    ...
    function addType($data)
    {
        ...
        $query = "
            ...
            select 
              ...
              values
              (
                (SELECT BSKObservElement_id AS LastID FROM dbo.BSKObservElement with(nolock) WHERE BSKObservElement_id = @@Identity),
                :BSKObject_id,
                :pmUser_insID,
                null,
                getdate(),
        ...
        */
		...
		$query = "
			...
			exec dbo.p_BSKObservElement_ins
			...
			exec dbo.p_BSKObservElementLink_ins
				@BSKObject_id = :BSKObject_id,
				@pmUser_id = :pmUser_id,
    ...
    function addValue($data)
    {
        ...
        */
        $query = "
			...
			exec dbo.p_BSKObservElementValues_ins
                @BSKObservElement_id = :BSKObservElement_id,
    ...
    function editGroupType($data)
    {
        ...
        */
		$query = "
			...
			exec dbo.p_BSKObservElementGroup_upd
				@BSKObservElementGroup_name = :BSKObservElementGroup_name,
				@BSKObservElementGroup_id = :BSKObservElementGroup_id,
				@pmUser_id = :pmUser_id,
				@Error_Code = @ErrCode output,
    ...
    function editType($data)
    {
        ...
        */
		$query = "
			...
			exec dbo.p_BSKObservElement_upd
				@BSKObservElement_id = :BSKObservElement_id,
                @BSKObservElement_name = :BSKObservElement_name,
                @BSKObservElementFormat_name = :BSKObservElementFormat_name,
                @BSKObservElement_symbol = :BSKObservElement_symbol,
    ...
    function editValue($data)
    {
        ...
        */
        $query = "
			...
			exec dbo.p_BSKObservElementValues_upd
                @BSKObservElementValues_id = :BSKObservElementValues_id,
                @BSKObservElementValues_data = :BSKObservElementValues_data,
                @BSKObservElementValues_min = :BSKObservElementValues_min,
                @BSKObservElementValues_max = :BSKObservElementValues_max,
    ...
    function deleteGroupType($data)
    {
        ...
        */
		$query = "
			...
			exec dbo.p_BSKObservElementGroup_del
				@BSKObservElementGroup_id = :BSKObservElementGroup_id,
				@pmUser_id = :pmUser_id,
				@Error_Code = @ErrCode output,
				@Error_Message = @ErrMessage output;
    ...
    function deleteType($data)
    {
        ...
        */
		$query = "
			...
			exec dbo.p_BSKObservElement_del
				@BSKObservElement_id = :BSKObservElement_id,
				@pmUser_id = :pmUser_id,
				@Error_Code = @ErrCode output,
				@Error_Message = @ErrMessage output;
    ...
    function deleteValue($data)
    {
        ...
        */
        $query = "
			...
			exec dbo.p_BSKObservElementValues_del
                @BSKObservElementValues_id = :BSKObservElementValues_id,
				@pmUser_id = :pmUser_id,
    ...
    function getTreeObjects()
    {
        ...
        $query = "  
                    ...
                    from dbo.BSK_GenObjObsn with(nolock)
                    ...
                    from dbo.BSKGroups_TypesInfo with(nolock)
                   ...
                   */
                    ...
                    from dbo.BSK_GenObjObsn o with(nolock)
                    left outer  join dbo.BSKGroups_TypesInfo g with(nolock) on g.BSK_GenObjObsn_id = o.BSK_genObjObsn_id and g.BSKGroups_TypesInfo_isActive = 2
                    left outer join dbo.BSK_TypesInfo ti with(nolock) on ti.BSKGroups_TypesInfo_id = g.BSKGroups_TypesInfo_id and ti.BSK_TypesInfo_isActive = 2
                    left outer join dbo.BSK_TypesInfoValues v with(nolock) on v.BSK_TypesInfo_id = ti.BSK_TypesInfo_id and v.BSK_TypesInfoValues_isActive = 2
                    left join dbo.BSK_TypesInfo_Format f with(nolock) on ti.BSK_TypesInfo_Format_id = f.BSK_TypesInfo_Format_id 
                    left join dbo.BSK_units u with(nolock) on ti.BSK_units_id = u.BSK_units_id
    ...
    function getFormatAndUnit($data)
    {
        ...
        $query = "
            ...
            u.BSK_units_name as unit
            from dbo.BSK_TypesInfo ti with(nolock)
            left join dbo.BSK_TypesInfo_Format tf with(nolock) on tf.BSK_TypesInfo_Format_id  = ti.BSK_TypesInfo_Format_id
            left join dbo.BSK_units u with(nolock) on u.BSK_units_id = ti.BSK_units_id
    ...
    function checkSymbol($data)
    {
        ...
        $query = "
            ...
            from dbo.BSKObservElement with(nolock)
