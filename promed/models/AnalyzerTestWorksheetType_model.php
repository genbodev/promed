 ...
 * @version
 */
class AnalyzerTestWorksheetType_model extends swModel {
	...
	function load() {
		$q = "
			...
			from
				lis.v_AnalyzerTestWorksheetType with (nolock)
			where
	...
	function loadList($filter) {
		...
		$q = "
			...
			FROM
				lis.v_AnalyzerTestWorksheetType WITH (NOLOCK)
				LEFT JOIN lis.v_AnalyzerTest AnalyzerTest_id_ref WITH (NOLOCK) ON AnalyzerTest_id_ref.AnalyzerTest_id = v_AnalyzerTestWorksheetType.AnalyzerTest_id
				left join v_UslugaComplex (nolock) uc on uc.UslugaComplex_id = AnalyzerTest_id_ref.UslugaComplex_id
				LEFT JOIN lis.v_AnalyzerWorksheetType AnalyzerWorksheetType_id_ref WITH (NOLOCK) ON AnalyzerWorksheetType_id_ref.AnalyzerWorksheetType_id = v_AnalyzerTestWorksheetType.AnalyzerWorksheetType_id
			$where_clause
		";
