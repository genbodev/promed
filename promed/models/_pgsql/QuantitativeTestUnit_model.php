 ...
 * @version
 */
class QuantitativeTestUnit_model extends SwPgModel {
	...
	function loadCoeff($data) {
		...
		$resp = $this->common->GET('UnitSpr/UnitConv', array(
	...
	function delete($data) {
		...
		$query = "
			select
				error_code as \"Error_Code\",
				error_message as \"Error_Msg\"
			from lis.p_QuantitativeTestUnit_del(
				QuantitativeTestUnit_id := :QuantitativeTestUnit_id
			)	
		";
