 ...
 * @version
 */
class MesUsluga_model extends SwPgModel {
    ...
    function load() {
        $q = "
			select
				...
				Mes_id as \"Mes_id\",
				MesUsluga_UslugaCount as \"MesUsluga_UslugaCount\",
				to_char(MesUsluga_begDT, 'DD.MM.YYYY') as \"MesUsluga_begDT\",
				to_char(MesUsluga_endDT, 'DD.MM.YYYY') as \"MesUsluga_endDT\"
			from
				dbo.v_MesUsluga
			where
    ...
    function loadList($filter) {
        ...
        $q = "
			SELECT
				...
				mu.Usluga_id as \"Usluga_id\",
				mu.UslugaComplex_id as \"UslugaComplex_id\",
				mu.Mes_id as \"Mes_id\",
				mu.MesUsluga_UslugaCount as \"MesUsluga_UslugaCount\",
				...
				to_char(mu.MesUsluga_begDT, 'DD.MM.YYYY') as \"MesUsluga_begDT\",
				to_char(mu.MesUsluga_endDT, 'DD.MM.YYYY') as \"MesUsluga_endDT\"
			FROM
				dbo.v_MesUsluga mu
				LEFT JOIN dbo.v_Usluga Usluga_id_ref ON Usluga_id_ref.Usluga_id = mu.Usluga_id
				LEFT JOIN dbo.v_UslugaComplex UslugaComplex_id_ref ON UslugaComplex_id_ref.UslugaComplex_id = mu.UslugaComplex_id
				LEFT JOIN dbo.v_MesOld Mes_id_ref ON Mes_id_ref.Mes_id = mu.Mes_id
			$where_clause
		";
