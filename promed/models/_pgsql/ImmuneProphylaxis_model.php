 ...
 *
 */
class ImmuneProphylaxis_model extends SwPgModel
{
	/**
	 *    Конструктор
	 */
 	...
 	function addTo_VacJournalAccount($data)
	{
		...
		$query = "select 
		        ...
		        where Person_id = :Person_id and vacJournalAccount_DateVac = :vacJournalAccount_DateVac 
	...
	function selectFrom_VacJournalAccount($data)
	{
		...
		select
			...
			vacJournalAccount_Purpose_MedPersonal_id as \"vacJournalAccount_Purpose_MedPersonal_id\",
			Vaccine_id as \"Vaccine_id\",
			vacJournalAccount_Seria as \"vacJournalAccount_Seria\",
			vacJournalAccount_Period as \"vacJournalAccount_Period\",
			vacJournalAccount_Dose as \"vacJournalAccount_Dose\",
			VaccineWay_id as \"VaccineWay_id\",
			VaccinePlace_id as \"VaccinePlace_id\",
			vacJournalAccount_DateVac as \"vacJournalAccount_DateVac\",
			vacJournalAccount_Lpu_id as \"vacJournalAccount_Lpu_id\",
			vacJournalAccount_Vac_MedPersonal_id as \"vacJournalAccount_Vac_MedPersonal_id\"
		from vac.vac_JournalAccount
	...
	function addTo_Vac_JournalMantu($data)
	{
		...
		where Person_id = :Person_id and JournalMantu_DateVac = :JournalMantu_DateVac 
            and TubDiagnosisType_id = :TubDiagnosisType_id
	...
	function selectFrom_Vac_JournalMantu($data)
	{
		...
		select
			JournalMantu_id as \"JournalMantu_id\",
			Person_id as \"Person_id\",
			JournalMantu_Dose as \"JournalMantu_Dose\",
			VaccineWay_id as \"VaccineWay_id\",
			VaccinePlace_id as \"VaccinePlace_id\",
			MantuReactionType_id as \"MantuReactionType_id\",
			JournalMantu_DateVac as \"JournalMantu_DateVac\",
			JournalMantu_Lpu_id as \"JournalMantu_Lpu_id\",
			JournalMantu_vacMedPersonal_id as \"JournalMantu_vacMedPersonal_id\",
