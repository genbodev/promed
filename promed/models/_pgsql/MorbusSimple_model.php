 ...
 */
class MorbusSimple_model extends SwPgModel
{
	/**
	...
	protected function _validate()
	{
		...
		if (self::SCENARIO_DELETE == $this->scenario) {
			...
			$evnData = $this->getFirstRowFromQuery('
				select Evn.Person_id as "Person_id", COALESCE(PL.Diag_id,ST.Diag_id) as "Diag_id"
				from v_Evn Evn
				left join EvnVizitPL PL on Evn.Evn_id = PL.EvnVizitPL_id
                left join EvnSection ST on Evn.Evn_id = ST.EvnSection_id
