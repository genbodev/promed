...
class DrugListRequest_model extends SwPgModel {
   ...
   function loadList($filter) {
		...
		$q = "
			SELECT
				...
				,DrugRequestProperty_id_ref.DrugRequestProperty_Name as \"DrugRequestProperty_id_Name\", 
                DrugTorgUse_id_ref.DrugTorgUse_Name as \"DrugTorgUse_id_Name\"
			FROM
				dbo.v_DrugListRequest
				LEFT JOIN dbo.v_DrugRequestProperty DrugRequestProperty_id_ref  ON DrugRequestProperty_id_ref.DrugRequestProperty_id = v_DrugListRequest.DrugRequestProperty_id
   ...
   function save() {
        ...
        from  dbo.{$procedure}
            (
				...
				DrugListRequest_Price := to_number(:DrugListRequest_Price),
