...
class Ufa_BSK_Register_model extends swPgModel
{
    ...
    public function listRecomendation($data)
    {
        ...
        $query = "
            select 
             ...
             from r2.BSKObservRecomendation
    ...
    function getRecomendations($data)
    {
        ...
        $query = "
            ...
            as \"mark\"
            from r2.BSKObservRecomendation R
            left join r2.BSKObservRecomendationLink RL on R.BSKObservRecomendation_id = RL.BSKObservRecomendation_id and RL.BSKObservRecomendationLink_deleted = 1
            left join  r2.BSKObservElementValues L on RL.BSKObservElementValues_id = L.BSKObservElementValues_id
            left join r2.BSKObservRecomendationType RT on RT.BSKObservRecomendationType_id = R.BSKObservRecomendationType_id
    ...
    function deleteRecomendation($data)
    {
        ...
        */
        $query = "
			...
			from r2.p_BSKObservRecomendationLink_del (
        ...
        */
        $query = "
			select
				Error_Code as \"Error_Code\",
				Error_Message as \"Error_Msg\"
            from r2.p_BSKEditRecomendation_del (
        ...
        */
		$query = "
			select
				Error_Code as \"Error_Code\",
				Error_Message as \"Error_Msg\"
			from r2.p_BSKEditRecomendation_upd (
        ...
        $query = "
            WITH t as (
				(select
						Error_Code,
                        Error_Message            
                    from r2.p_BSKPreRecomendation_ins (
                        BSKObservRecomendation_id := :BSKObservRecomendation_id,
                        BSKObservElementValues_id := :BSKObservElementValues_id,
                        pmUser_id := :pmUser_id
                    where (select count(BSKObservRecomendationLink_id) from r2.BSKObservRecomendationLink where BSKObservElementValues_id = :BSKObservElementValues_id and BSKObservRecomendation_id = :BSKObservRecomendation_id) = 0
        		...
        		(select
                        Error_Code,
                        Error_Message
                    from r2.p_BSKPreRecomendation_upd (
                        BSKObservRecomendation_id := :BSKObservRecomendation_id,
                        BSKObservElementValues_id := :BSKObservElementValues_id,
                        pmUser_id := :pmUser_id
                    where (select count(BSKObservRecomendationLink_id) from r2.BSKObservRecomendationLink where BSKObservElementValues_id = :BSKObservElementValues_id and BSKObservRecomendation_id = :BSKObservRecomendation_id) <> 0
            ...
            SELECT t.Error_Code as \"Error_Code\", t.Error_Message as \"Error_Message\" FROM t;       
        ";
    ...
    function addRecomendation($data)
    {
        ...
        $query = "
			select
                Error_Code as \"Error_Code\",
				Error_Message as \"Error_Msg\"
			from r2.p_BSKRecomendation_ins (
    			BSKObservRecomendation_text := :BSKObservRecomendation_text,
                BSKObservRecomendationType_id := :BSKObservRecomendationType_id,
    			pmUser_id := :pmUser_id
    		);
        ...
        if ($data['action'] == 'set') {
            ...
            WITH t as (
                (select
                        Error_Code,
                        Error_Message            
                    from r2.p_BSKObservElementLink_upd
        		...
        		(select
                        Error_Code,
                        Error_Message            
                    from r2.p_BSKObservElementLinkAdd_ins
                        BSKObservElement_id := :BSKObservElement_id,
                        BSKObject_id := :BSKObject_id,
                        BSKObservElementLink_deleted := 1,
            			pmUser_id := :pmUser_id
    ...
    function getListObjects($data)
    {
        ...
        $query = "
            ...
            from r2.BSKObject O
            left join dbo.MorbusType M on M.MorbusType_id = O.MorbusType_id   
        ...
        $query = "
            select 
                ...
                (select 
    			 ...
    			 from r2.BSKObservElementFormat
    ...
    function getListValues($data)
    {
        ...
        $query = "
           select 
              ...
              BSKObservElementValues_sign as \"BSKObservElementValues_sign\",
        ...
        */
        $query = "
			...
			select
				Error_Code as \"Error_Code\",
				Error_Message as \"Error_Msg\"
			from r2.p_BSKObservElementGroup_ins (
        ...
        */
        ...
        $query = "
            ...
            select
                Error_Code as \"Error_Code\",
				Error_Message as \"Error_Msg\"
			from r2.p_BSKObservElement_ins (
            ...
            select
                Error_Code as \"Error_Code\",
				Error_Message as \"Error_Msg\";
            from r2.p_BSKObservElementLink_ins (
				BSKObject_id := :BSKObject_id,
				pmUser_id := :pmUser_id    
				);        
		";
        ...
        */
        $query = "
            ...
            select
                Error_Code as \"Error_Code\",
				Error_Message as \"Error_Msg\"
			from r2.p_BSKObservElementValues_ins (
                BSKObservElement_id := :BSKObservElement_id,
        ...
        */
        $query = "
            ...
            select
                Error_Code as \"Error_Code\",
				Error_Message as \"Error_Msg\"
			from r2.p_BSKObservElementGroup_upd (
				BSKObservElementGroup_name := :BSKObservElementGroup_name,
				BSKObservElementGroup_id := :BSKObservElementGroup_id,
				pmUser_id := :pmUser_id
				);
        ...
        */
        $query = "
            select
                Error_Code as \"Error_Code\",
				Error_Message as \"Error_Msg\"
			from r2.p_BSKObservElement_upd (
				BSKObservElement_id := :BSKObservElement_id,
                BSKObservElement_name := :BSKObservElement_name,
                BSKObservElementFormat_name := :BSKObservElementFormat_name,
                BSKObservElement_symbol := :BSKObservElement_symbol,
        ...
        */
        $query = "
            select
               Error_Code as \"Error_Code\",
			   Error_Message as \"Error_Msg\"
			from r2.p_BSKObservElementValues_upd (
                BSKObservElementValues_id := :BSKObservElementValues_id,
                BSKObservElementValues_data := :BSKObservElementValues_data,
                BSKObservElementValues_min := :BSKObservElementValues_min,
                BSKObservElementValues_max := :BSKObservElementValues_max,
    ...
    function deleteObject($object_name, $data)
    {
        ...
        $query = "
             update {$this->scheme}.BSK_GenObjObsn set 
                 ...
                 BSK_genObjObsn_updDT = dbo.tzGetDate(),
                 pmUser_updID = :pmUser_updID
        ...
        */
        $query = "
            select
                Error_Code as \"Error_Code\",
				Error_Message as \"Error_Msg\"
			from r2.p_BSKObservElementGroup_del (
				BSKObservElementGroup_id := :BSKObservElementGroup_id,
				pmUser_id := :pmUser_id
				);
		";
        ...
        */
        $query = "
            select
                Error_Code as \"Error_Code\",
				Error_Message as \"Error_Msg\"
			from r2.p_BSKObservElement_del (
				BSKObservElement_id := :BSKObservElement_id,
				pmUser_id := :pmUser_id
				);
		";
        ...
        */
        $query = "
            select
                Error_Code as \"Error_Code\",
				Error_Message as \"Error_Msg\"
			from r2.p_BSKObservElementValues_del (
                BSKObservElementValues_id := :BSKObservElementValues_id,
				pmUser_id := :pmUser_id
				);        
        ";
    ...
    function getTreeObjects()
    {
        ...
        $query = "  
                   ...
                   */
                    ...
                    from r2.BSK_GenObjObsn o 
                    left outer  join r2.BSKGroups_TypesInfo g  on g.BSK_GenObjObsn_id = o.BSK_genObjObsn_id and g.BSKGroups_TypesInfo_isActive = 2
                    left outer join r2.BSK_TypesInfo ti on ti.BSKGroups_TypesInfo_id = g.BSKGroups_TypesInfo_id and ti.BSK_TypesInfo_isActive = 2
                    left outer join r2.BSK_TypesInfoValues v on v.BSK_TypesInfo_id = ti.BSK_TypesInfo_id and v.BSK_TypesInfoValues_isActive = 2
                    left join r2.BSK_TypesInfo_Format f on ti.BSK_TypesInfo_Format_id = f.BSK_TypesInfo_Format_id 
                    left join r2.BSK_units u on ti.BSK_units_id = u.BSK_units_id
    ...
    function getFormatAndUnit($data)
    {
        ...
        $query = "
            ...
            u.BSK_units_name as \"unit\"
            from r2.BSK_TypesInfo ti
            left join r2.BSK_TypesInfo_Format tf on tf.BSK_TypesInfo_Format_id  = ti.BSK_TypesInfo_Format_id
            left join r2.BSK_units u on u.BSK_units_id = ti.BSK_units_id
