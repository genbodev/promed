...
* @version      10.09.2013
*/
class Demand_model_VE extends SwPgModel {
	/**
	* constructor
	*/
    ...
    */
	function getOrgSmoUfaList() {	
		...
		$query = "
             ...
             Replace(REPLACE(O.OrgSMO_Nick,'(РЕСПУБЛИКА БАШКОРТОСТАН)',''), '''', '') as \"Smo_Name\", 
             Replace(REPLACE(O.OrgSMO_Nick,'(РЕСПУБЛИКА БАШКОРТОСТАН)',''), '''', '') as \"Smo_Nick\"
             from v_orgSmo O where KLRgn_id=2 and OrgSmo_endDate is null
		";
