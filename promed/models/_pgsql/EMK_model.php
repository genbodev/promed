...
class EMK_model extends SwPgModel
{
	/**
	 * Comment
	 */
	...
	*/
	function getGroupNodeData($data)
	{
		...
		$query = "
			select
				GroupNode_id as \"GroupNode_id\",
				GroupNode_Code as \"GroupNode_Code\",
				...
				GroupNode_isLeaf as \"GroupNode_isLeaf\",
				GroupNode_cls as \"cls\",
				GroupNode_isHidden as \"GroupNode_isHidden\",
				GroupNode_NameView as \"GroupNode_NameView\",
				GroupNode_FieldOrder as \"GroupNode_FieldOrder\"
			from
				v_TreeViewEMK
			where
	...
	function getLastDirectionVKforVMP($data){
		$query = "
			select
				...
				EVK.EvnVK_IsArchive as \"EvnVK_IsArchive\",
				EVK.Diag_id as \"Diag_id\",
				EPVK.EvnPrescrVK_pid as \"EvnPrescrVK_pid\",
				EVK.EvnVK_setDT as \"EvnVK_setDT\",
				...
				EvnVK_IsFail as \"EvnVK_IsFail\",
				EVK.PersonEvn_id as \"PersonEvn_id\",
				EVK.Server_id as \"Server_id\",
				PA.Person_Fio as \"Person_Fio\",
				PA.Person_SurName as \"Person_SurName\",
				PA.Person_Firname as \"Person_Firname\",
				PA.Person_Secname as \"Person_Secname\",
			...
			where 
				...
				and coalesce(EVK.EvnVK_IsArchive, 1) = 1
				and coalesce(EVK.EvnVK_IsFail, 1) != 2
