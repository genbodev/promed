...
class MorbusCrazyBase_model extends MorbusBase_model
{
    ...
    function __construct()
    {
        ...
        $this->MorbusCrazyBaseDrugStart->setInputRules([
            ['field' => 'MorbusCrazyBaseDrugStart_id', 'label' => '', 'rules' => '', 'type' => 'int'],// NULL
            ['field' => 'MorbusCrazyBase_id', 'label' => 'Общее заболевание', 'rules' => 'required', 'type' => 'id'],// Общее заболевание
            ['field' => 'MorbusCrazyBaseDrugStart_Name', 'label' => 'Наименование вещества', 'rules' => '', 'type' => 'string'],// Наименование вещества
            ['field' => 'CrazyDrugReceptType_id', 'label' => 'Тип приема', 'rules' => '', 'type' => 'id'],// Тип приема
            ['field' => 'MorbusCrazyBaseDrugStart_Age', 'label' => 'Полных лет', 'rules' => '', 'type' => 'id'],// Полных лет
    ...
    public function save()
    {
        ...
        if ($save_ok){
            ...
            $result = $this->MorbusCrazyBaseDrugStart->saveAll($parameters);
        }
        return $result;
    }
    ...
    public function getFields()
    {
        return array_merge(
            parent::getFields(),
            ['MorbusCrazyBaseDrugStart' => $this->MorbusCrazyBaseDrugStart->getItems()]
        );
    }
	 ...
	 * @throws Exception
	 */
    public function load($field = null, $value = null)
    {
	...
	/**
	 * @param array $params
	 * @param array $query_paramlist_exclude
	 * @return array
	 */
