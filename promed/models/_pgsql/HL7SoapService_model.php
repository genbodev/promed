 ...
 */
class HL7SoapService_model extends swPgModel
{
		...
		switch ($eventType) {
			...
			case 'S06': // Метод в HL7 : Отказ в записи на прием
				...
				$selectString = "
					...
					a.KLRGN_Name as \"KLRGN_Name\",
					a.KLSubRGN_Name as \"KLSubRGN_Name\",
					a.KLCity_Name as \"KLCity_Name\",
					a.KLTown_Name as \"KLTown_Name\",
					a.KLStreet_Name as \"KLStreet_Name\",
				...
				$resp_ps = $this->queryResult("
					...
					from
						...
						left join v_Address_all a on a.Address_id = ps.PAddress_id
					where
