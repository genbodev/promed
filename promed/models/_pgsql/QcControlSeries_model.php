...
class QcControlSeries_model extends Scenario_model {
	...
	function doLoadData($data = array()) {
		...
		$query = "
			SELECT
				...
				childSeries.QcControlSeries_pid as \"QcControlSeries_pid\",
				parentSeries.QcControlSeries_Name as \"QcControlSeries_Name\",
				parentSeries.QcControlMaterialValue_id as \"QcControlMaterialValue_id\",
				childSeries.QcControlStage_id as \"QcControlStage_id\",
				...
				childSeries.QcControlSeries_CV as \"QcControlSeries_CV\",
				childSeries.QcControlSeries_B as \"QcControlSeries_B\",
				childSeries.QcControlSeries_IsControlPassed as \"QcControlSeries_IsControlPassed\",
				to_char(childSeries.QcControlSeries_begDT, 'DD.MM.YYYY') as \"QcControlSeries_begDT\",
				to_char(childSeries.QcControlSeries_endDT, 'DD.MM.YYYY') as \"QcControlSeries_endDT\",
				QCM.QcControlMaterial_id as \"QcControlMaterial_id\",
				...
				QCMV.QcControlMaterialValue_CV10 as \"QcControlMaterialValue_CV10\",
			...
			LEFT JOIN LATERAL (
				...
				ORDER BY QcControlSeries_insDT desc
				LIMIT 1
			) as childSeries on true
			LEFT JOIN lis.v_QcControlStage QCStage on QCStage.QcControlStage_id = childSeries.QcControlStage_id
			LEFT JOIN lis.v_QcControlMaterialValue QCMV on QCMV.QcControlMaterialValue_id = coalesce(parentSeries.QcControlMaterialValue_id, childSeries.QcControlMaterialValue_id)
			...
			WHERE (1=1) {$where}
			ORDER BY childSeries.QcControlSeries_endDT desc, childSeries.QcControlSeries_begDT desc
		";
	...
	public function doLoadCombo($data = array()) {
		...
		$query = "
			select 
				QCS.QcControlSeries_id as \"QcControlSeries_id\",
				QCS.QcControlSeries_pid as \"QcControlSeries_pid\",
				begDT.begDT as \"begDT\",
				endDT.endDT as \"endDT\",
				QCS.QcControlSeries_endDT as \"QcControlSeries_endDT\",
				QCS.QcControlSeries_begDT as \"QcControlSeries_begDT\",
				QCS.QcControlStage_id as \"QcControlStage_id\",
				QCS.QcControlSeries_IsControlPassed as \"QcControlSeries_IsControlPassed\",
				QCS.QcControlSeries_Xcp as \"QcControlSeries_Xcp\",
				QCS.QcControlSeries_S as \"QcControlSeries_S\",
				QCS.QcControlSeries_CV as \"QcControlSeries_CV\",
				QCS.QcControlSeries_B as \"QcControlSeries_B\",
				QcStage.QcControlStage_Name as \"QcControlStage_Name\"
			...
			LEFT JOIN LATERAL (
				...
				from
					lis.QcControlSeriesValue
				where
					QcControlSeries_id = QCS.QcControlSeries_id
				LIMIT 1
			) begDT on true
			LEFT JOIN LATERAL (
				select
