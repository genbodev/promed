 ...
 * @version
 */
class AnalyzerWorksheetType_model extends SwPgModel {
	...
	function loadList($filter) {
		...
		$q = "
			...
			FROM
				lis.v_AnalyzerWorksheetType
				LEFT JOIN lis.v_AnalyzerModel AnalyzerModel_id_ref ON AnalyzerModel_id_ref.AnalyzerModel_id = v_AnalyzerWorksheetType.AnalyzerModel_id
			$where_clause
		";
