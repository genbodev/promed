		...
		$query = "
			...
			FROM
				...
				LEFT JOIN LATERAL (
					...
					where PR.Person_id = PP.Person_id and PR.PersonRefuse_Year = extract(year from CAST(dbo.tzGetDate() as date))
	...
	function getViewData($data)
	{
		...
		$query = "
			SELECT
				...
				,to_char (pcard.LpuRegion_Name::date, 'dd.mm.yyyy') as \"LpuRegion_Name\"
		...
		$query = "
			with PR as (
				select
					...
					PRD.MorbusType_id as MorbusType_id
