...
class SvodRegistry_model extends swPgModel
{
	 ...
	 * Получение параметра
	 */
	public function getRegistry_id()
	{
	 ...
	 * Установка параметра
	 */
	public function setRegistry_id($value)
	{
		$this->Registry_id = $value;
	}

	/**
	 * Получение параметра
	 */
	public function getRegistryType_id()
	{
		return $this->RegistryType_id;
	}

	/**
	 * Установка параметра
	 */
	public function setRegistryType_id($value)
	{
		$this->RegistryType_id = $value;
	}

	/**
	 * Получение параметра
	 */
	public function getLpu_id()
	{
		return $this->Lpu_id;
	}
	 ...
	 * Установка параметра
	 */
	public function setLpu_id($value)
	{
		$this->Lpu_id = $value;
	}
	 ...
	 * Получение параметра
	 */
	public function getRegistry_begDate()
	{
		return $this->Registry_begDate;
	}

	/**
	 * Установка параметра
	 */
	public function setRegistry_begDate($value)
	{
		$this->Registry_begDate = $value;
	}

	/**
	 * Получение параметра
	 */
	public function getRegistry_endDate()
	{
		return $this->Registry_endDate;
	}

	/**
	 * Установка параметра
	 */
	public function setRegistry_endDate($value)
	{
		$this->Registry_endDate = $value;
	}

	/**
	 * Получение параметра
	 */
	public function getKatNasel_id()
	{
		return $this->KatNasel_id;
	}

	/**
	 * Установка параметра
	 */
	public function setKatNasel_id($value)
	{
		$this->KatNasel_id = $value;
	}

	/**
	 * Получение параметра
	 */
	public function getRegistry_Num()
	{
	 ...
	 * Установка параметра
	 */
	public function setRegistry_Num($value)
	{
		$this->Registry_Num = $value;
	}

	/**
	 * Получение параметра
	 */
	public function getRegistry_accDate()
	{
		return $this->Registry_accDate;
	}

	/**
	 * Установка параметра
	 */
	public function setRegistry_accDate($value)
	{
		$this->Registry_accDate = $value;
	}

	/**
	 * Получение параметра
	 */
	public function getRegistryStatus_id()
	{
		return $this->RegistryStatus_id;
	}

	/**
	 * Установка параметра
	 */
	public function setRegistryStatus_id($value)
	{
		$this->RegistryStatus_id = $value;
	}

	/**
	 * Получение параметра
	 */
	public function getRegistry_Sum()
	{
		return $this->Registry_Sum;
	}

	/**
	 * Установка параметра
	 */
	public function setRegistry_Sum($value)
	{
		$this->Registry_Sum = $value;
	}

	/**
	 * Получение параметра
	 */
	public function getRegistry_IsActive()
	{
		return $this->Registry_IsActive;
	}

	/**
	 * Установка параметра
	 */
	public function setRegistry_IsActive($value)
	{
		$this->Registry_IsActive = $value;
	}

	/**
	 * Получение параметра
	 */
	public function getRegistry_ErrorCount()
	{
		return $this->Registry_ErrorCount;
	}

	/**
	 * Установка параметра
	 */
	public function setRegistry_ErrorCount($value)
	{
		$this->Registry_ErrorCount = $value;
	}

	/**
	 * Получение параметра
	 */
	public function getRegistry_ErrorCommonCount()
	{
		return $this->Registry_ErrorCommonCount;
	}

	/**
	 * Установка параметра
	 */
	public function setRegistry_ErrorCommonCount($value)
	{
		$this->Registry_ErrorCommonCount = $value;
	}

	/**
	 * Получение параметра
	 */
	public function getRegistry_RecordCount()
	{
		return $this->Registry_RecordCount;
	}

	/**
	 * Установка параметра
	 */
	public function setRegistry_RecordCount($value)
	{
		$this->Registry_RecordCount = $value;
	}

	/**
	 * Получение параметра
	 */
	public function getOrgRSchet_id()
	{
		return $this->OrgRSchet_id;
	}

	/**
	 * Установка параметра
	 */
	public function setOrgRSchet_id($value)
	{
		$this->OrgRSchet_id = $value;
	}

	/**
	 * Получение параметра
	 */
	public function getRegistry_ExportPath()
	{
		return $this->Registry_ExportPath;
	}

	/**
	 * Установка параметра
	 */
	public function setRegistry_ExportPath($value)
	{
		$this->Registry_ExportPath = $value;
	}

	/**
	 * Получение параметра
	 */
	public function getRegistry_expDT()
	{
		return $this->Registry_expDT;
	}

	/**
	 * Установка параметра
	 */
	public function setRegistry_expDT($value)
	{
		$this->Registry_expDT = $value;
	}

	/**
	 * Получение параметра
	 */
	public function getRegistryStacType_id()
	{
		return $this->RegistryStacType_id;
	}

	/**
	 * Установка параметра
	 */
	public function setRegistryStacType_id($value)
	{
		$this->RegistryStacType_id = $value;
	}

	/**
	 * Установка параметра
	 */
	public function setRegistryEventType_id($value)
	{
		$this->RegistryEventType_id = $value;
	}

	/**
	 * Получение параметра
	 */
	public function getRegistry_RecordPaidCount()
	{
		return $this->Registry_RecordPaidCount;
	}

	/**
	 * Установка параметра
	 */
	public function setRegistry_RecordPaidCount($value)
	{
		$this->Registry_RecordPaidCount = $value;
	}

	/**
	 * Получение параметра
	 */
	public function getRegistry_KdCount()
	{
		return $this->Registry_KdCount;
	}

	/**
	 * Установка параметра
	 */
	public function setRegistry_KdCount($value)
	{
		$this->Registry_KdCount = $value;
	}

	/**
	 * Получение параметра
	 */
	public function getRegistry_KdPaidCount()
	{
		return $this->Registry_KdPaidCount;
	}

	/**
	 * Установка параметра
	 */
	public function setRegistry_KdPaidCount($value)
	{
		$this->Registry_KdPaidCount = $value;
	}

	/**
	 * Получение параметра
	 */
	public function getRegistry_xmlExportPath()
	{
		return $this->Registry_xmlExportPath;
	}

	/**
	 * Установка параметра
	 */
	public function setRegistry_xmlExportPath($value)
	{
		$this->Registry_xmlExportPath = $value;
	}

	/**
	 * Получение параметра
	 */
	public function getRegistry_xmlExpDT()
	{
		return $this->Registry_xmlExpDT;
	}

	/**
	 * Установка параметра
	 */
	public function setRegistry_xmlExpDT($value)
	{
		$this->Registry_xmlExpDT = $value;
	}

	/**
	 * Получение параметра
	 */
	public function getRegistryCheckStatus_id()
	{
		return $this->RegistryCheckStatus_id;
	}

	/**
	 * Установка параметра
	 */
	public function setRegistryCheckStatus_id($value)
	{
		$this->RegistryCheckStatus_id = $value;
	}

	/**
	 * Получение параметра
	 */
	public function getRegistry_Task()
	{
		return $this->Registry_Task;
	}

	/**
	 * Установка параметра
	 */
	public function setRegistry_Task($value)
	{
		$this->Registry_Task = $value;
	}

	/**
	 * Получение параметра
	 */
	public function getLpuBuilding_id()
	{
		return $this->LpuBuilding_id;
	}

	/**
	 * Установка параметра
	 */
	public function setLpuBuilding_id($value)
	{
		$this->LpuBuilding_id = $value;
	}

	/**
	 * Получение параметра
	 */
	public function getPayType_id()
	{
	 ...
	 * Установка параметра
	 */
	public function setPayType_id($value)
	{
		$this->PayType_id = $value;
	}

	/**
	 * Получение параметра
	 */
	public function getRegistry_SumPaid()
	{
		return $this->Registry_SumPaid;
	}

	/**
	 * Установка параметра
	 */
	public function setRegistry_SumPaid($value)
	{
		$this->Registry_SumPaid = $value;
	}

	/**
	 * Получение параметра
	 */
	public function getRegistry_CheckStatusDate()
	{
		return $this->Registry_CheckStatusDate;
	}

	/**
	 * Установка параметра
	 */
	public function setRegistry_CheckStatusDate($value)
	{
		$this->Registry_CheckStatusDate = $value;
	}

	/**
	 * Получение параметра
	 */
	public function getRegistry_CheckStatusTFOMSDate()
	{
		return $this->Registry_CheckStatusTFOMSDate;
	}

	/**
	 * Установка параметра
	 */
	public function setRegistry_CheckStatusTFOMSDate($value)
	{
		$this->Registry_CheckStatusTFOMSDate = $value;
	}

	/**
	 * Получение параметра
	 */
	public function getRegistry_sendDT()
	{
		return $this->Registry_sendDT;
	}

	/**
	 * Установка параметра
	 */
	public function setRegistry_sendDT($value)
	{
		$this->Registry_sendDT = $value;
	}

	/**
	 * Получение параметра
	 */
	public function getRegistry_IsNeedReform()
	{
		return $this->Registry_IsNeedReform;
	}

	/**
	 * Установка параметра
	 */
	public function setRegistry_IsNeedReform($value)
	{
		$this->Registry_IsNeedReform = $value;
	}
	 ...
	 * Установка параметра
	 */
	public function setOrg_id($value)
	{
		$this->Org_id = $value;
	}
				...
				Registry_id as \"Registry_id\",
				 RegistryType_id as \"RegistryType_id\",
				  Lpu_id as \"Lpu_id\",
			       ...
			       Registry_RecordPaidCount as \"Registry_RecordPaidCount\", 
			       Registry_KdCount as \"Registry_KdCount\", 
			       Registry_KdPaidCount as \"Registry_KdPaidCount\", 
			       ...
			       Registry_Task as \"Registry_Task\", 
			       LpuBuilding_id as \"LpuBuilding_id\", 
			       PayType_id as \"PayType_id\", 
			       Registry_SumPaid as \"Registry_SumPaid\", 
			       Registry_CheckStatusDate as \"Registry_CheckStatusDate\", 
			       Registry_CheckStatusTFOMSDate as \"Registry_CheckStatusTFOMSDate\", 
			       Registry_sendDT as \"Registry_sendDT\", 
	...
	function loadList($filter)
	{
		...
		$q = "
			select
				v_Registry.Registry_id as \"Registry_id\",
				FinDocument.FinDocument_id as \"FinDocument_id\",
				v_Registry.RegistryType_id, v_Registry.Lpu_id as \"Lpu_id\",
				to_char(v_Registry.Registry_begDate, 'dd.mm.yyyy') as \"Registry_begDate\",
				to_char(v_Registry.Registry_endDate, 'dd.mm.yyyy') as \"Registry_endDate\",
				v_Registry.KatNasel_id as \"KatNasel_id\", 
			       v_Registry.Registry_Num as \"Registry_Num\", 
			       v_Registry.Registry_accDate as \"Registry_accDate\", 
			       v_Registry.RegistryStatus_id as \"RegistryStatus_id\", 
			       v_Registry.Registry_Sum as \"Registry_Sum\", 
			       v_Registry.Registry_IsActive as \"Registry_IsActive\", 
			       v_Registry.Registry_ErrorCount as \"Registry_ErrorCount\", 
			       v_Registry.Registry_ErrorCommonCount as \"Registry_ErrorCommonCount\", 
			       v_Registry.Registry_RecordCount as \"Registry_RecordCount\",
				v_Registry.OrgRSchet_id as \"OrgRSchet_id\",
				coalesce(Org_id_ref.Org_Name, Org.Org_Name) as \"Org_Name\",
				v_Registry.Registry_ExportPath as \"Registry_ExportPath\", 
			       v_Registry.Registry_expDT as \"Registry_expDT\", 
			       v_Registry.RegistryStacType_id as \"RegistryStacType_id\", 
			       v_Registry.Registry_RecordPaidCount as \"Registry_RecordPaidCount\", 
			       v_Registry.Registry_KdCount as \"Registry_KdCount\", 
			       v_Registry.Registry_KdPaidCount as \"Registry_KdPaidCount\", 
			       v_Registry.Registry_xmlExportPath as \"Registry_xmlExportPath\", 
			       v_Registry.Registry_xmlExpDT,  as \"Registry_xmlExpDT\"
			       v_Registry.RegistryCheckStatus_id as \"RegistryCheckStatus_id\", 
			       v_Registry.Registry_Task as \"Registry_Task\", 
			       v_Registry.LpuBuilding_id as \"LpuBuilding_id\", 
			       v_Registry.PayType_id as \"PayType_id\", 
			       v_Registry.Registry_SumPaid as \"Registry_SumPaid\", 
			       v_Registry.Registry_CheckStatusDate as \"Registry_CheckStatusDate\", 
			       v_Registry.Registry_CheckStatusTFOMSDate as \"Registry_CheckStatusTFOMSDate\", 
			       v_Registry.Registry_sendDT as \"Registry_sendDT\", 
			       v_Registry.Registry_IsNeedReform as \"Registry_IsNeedReform\",
				v_Registry.DrugFinance_id as \"DrugFinance_id\", 
			       v_Registry.WhsDocumentCostItemType_id,  as \"WhsDocumentCostItemType_id\",
			       v_Registry.Org_id as \"Org_id\",
				Lpu_id_ref.Lpu_Name as \"Lpu_id_Name\", 
			       KatNasel_id_ref.KatNasel_Name as \"KatNasel_id_Name\",
				RegistryStatus_id_ref.RegistryStatus_Code as \"RegistryStatus_Code\",
				RegistryStatus_id_ref.RegistryStatus_Name as \"RegistryStatus_Name\",
				Registry_IsActive_ref.YesNo_Name as \"Registry_IsActive_Name\", 
			       OrgRSchet_id_ref.OrgRSchet_Name as \"OrgRSchet_id_Name\", 
			       RegistryStacType_id_ref.RegistryStacType_Name as \"RegistryStacType_id_Name\", 
			       RegistryCheckStatus_id_ref.RegistryCheckStatus_Name as \"RegistryCheckStatus_id_Name\", 
			       LpuBuilding_id_ref.LpuBuilding_Name as \"LpuBuilding_id_Name\", 
			       PayType_id_ref.PayType_Name as \"PayType_id_Name\", 
			       Registry_IsNeedReform_ref.YesNo_Name as \"Registry_IsNeedReform_Name\",
				DrugFinance_id_ref.DrugFinance_Name as \"DrugFinance_id_Name\", 
			       WhsDocumentCostItemType_id_ref.WhsDocumentCostItemType_Name as \"WhsDocumentCostItemType_id_Name\", 
			       Org_id_ref.Org_Name as \"Org_id_Name\",
				FinDocument.FinDocument_Number as \"FinDocument_Number\",
				to_char(FinDocument.FinDocument_Date, 'dd.mm.yyyy') as \"FinDocument_Date\",
				FinDocument.FinDocument_Sum, as \"FinDocument_Sum\"
				(
					select
			...
			from
				{$this->schema}.v_Registry
				left join dbo.v_FinDocument FinDocument := on FinDocument.Registry_id = v_Registry.Registry_id and FinDocument.FinDocumentType_id = 1 -- Счет
				left join dbo.v_Lpu Lpu_id_ref := on Lpu_id_ref.Lpu_id = v_Registry.Lpu_id
				left join dbo.v_KatNasel KatNasel_id_ref := on KatNasel_id_ref.KatNasel_id = v_Registry.KatNasel_id
				left join dbo.v_RegistryStatus RegistryStatus_id_ref := on RegistryStatus_id_ref.RegistryStatus_id = v_Registry.RegistryStatus_id
				left join dbo.v_YesNo Registry_IsActive_ref := on Registry_IsActive_ref.YesNo_id = v_Registry.Registry_IsActive
				left join dbo.v_OrgRSchet OrgRSchet_id_ref := on OrgRSchet_id_ref.OrgRSchet_id = v_Registry.OrgRSchet_id
				left join dbo.v_Org Org := on Org.Org_id = OrgRSchet_id_ref.Org_id
				left join dbo.v_RegistryStacType RegistryStacType_id_ref := on RegistryStacType_id_ref.RegistryStacType_id = v_Registry.RegistryStacType_id
				left join dbo.v_RegistryCheckStatus RegistryCheckStatus_id_ref := on RegistryCheckStatus_id_ref.RegistryCheckStatus_id = v_Registry.RegistryCheckStatus_id
				left join dbo.v_LpuBuilding LpuBuilding_id_ref := on LpuBuilding_id_ref.LpuBuilding_id = v_Registry.LpuBuilding_id
				left join dbo.v_PayType PayType_id_ref := on PayType_id_ref.PayType_id = v_Registry.PayType_id
				left join dbo.v_YesNo Registry_IsNeedReform_ref := on Registry_IsNeedReform_ref.YesNo_id = v_Registry.Registry_IsNeedReform
				left join dbo.v_DrugFinance DrugFinance_id_ref := on DrugFinance_id_ref.DrugFinance_id = v_Registry.DrugFinance_id
				left join dbo.v_WhsDocumentCostItemType WhsDocumentCostItemType_id_ref := on WhsDocumentCostItemType_id_ref.WhsDocumentCostItemType_id = v_Registry.WhsDocumentCostItemType_id
				left join dbo.v_Org Org_id_ref := on Org_id_ref.Org_id = v_Registry.Org_id
				left join dbo.v_RegistryType RegistryType_id_ref := on RegistryType_id_ref.RegistryType_id = v_Registry.RegistryType_id
				left join lateral (
					select
						string_agg(distinct wdu.WhsDocumentUc_Num, ',') as Num_List
					from
						{$this->schema}.v_RegistryDataRecept rdr
						inner join WhsDocumentUc wdu on wdu.WhsDocumentUc_id = rdr.WhsDocumentSupply_id
					where
	...
	function save()
	{
		...
		$q = "
			...
			from {$this->schema}." . $procedure . " (
				...
				Registry_Num := (
						select case WHEN Registry_Num is NULL THEN (
							select max(
								cast(
									case
										when (Registry_Num ~ '^([0-9]+[.]?[0-9]*|[.][0-9]+)$') = true then Registry_Num
										else '0'
									end
								as numeric)
							) + 1)
							else Registry_Num END
						from
	...
	function delete()
	{
		$q = "
			select 
					error_code as \"Error_Code\", 
            		error_message as \"Error_Msg\"
            from {$this->schema}.p_Registry_del (
				Registry_id := :Registry_id,
	...
	function saveRegistryDataRecept($data)
	{
		...
		$q = "
			select	registrydatarecept_id as \"RegistryDataRecept_id\", 
					error_code as \"Error_Code\", 
					error_message as \"Error_Msg\"
			from {$this->schema}." . $procedure . "
	...
	function loadRegistryDataReceptList($filter)
	{
		...
		$q = "
			select
				...
				coalesce(ynir.YesNo_Code, 0) as \"IsReceived\",
				rs.RegistryStatus_Code as \"RegistryStatus_Code\"
			from
				{$this->schema}.v_RegistryDataRecept rdr
				left join {$this->schema}.v_Registry r on r.Registry_id = rdr.Registry_id
				...
				left join v_YesNo ynir on ynir.YesNo_id = rdr.RegistryDataRecept_IsReceived
			$where_clause
		";
		$result = $this->db->query($q, $filter);
		if (is_object($result)) {
	...
	function loadReceptStatusFLKMEKList($filter)
	{
		$q = "
			select
				rsfm.ReceptStatusFLKMEK_id as \"ReceptStatusFLKMEK_id\",
				rsfm.ReceptStatusFLKMEK_Code as \"ReceptStatusFLKMEK_Code\",
				rsfm.ReceptStatusFLKMEK_Name as \"ReceptStatusFLKMEK_Name\"
			from
				{$this->schema}.v_ReceptStatusFLKMEK rsfm
			order by
	...
	function setReceptIsReceived($data)
	{
		...
		$q = "
			...
			set
				RegistryDataRecept_IsReceived = (select YesNo_id from v_YesNo  where YesNo_Code = :YesNo_Code limit 1),
				ReceptStatusFLKMEK_id = (select ReceptStatusFLKMEK_id from ReceptStatusFLKMEK where ReceptStatusFLKMEK_code = :ReceptStatusFLKMEK_code limit 1)
			where
				RegistryDataRecept_id = :RegistryDataRecept_id;
		";
		$p = array(
		...
		$q = "
			select
				rs.ReceptStatusFLKMEK_Name as \"ReceptStatusFLKMEK_Name\"
			from
				{$this->schema}.RegistryDataRecept rdr
				left join ReceptStatusFLKMEK rs on rs.ReceptStatusFLKMEK_id = rdr.ReceptStatusFLKMEK_id
			where
				...
				set
					RegistryStatus_id = (
						...
						where
							...
							select
								CASE 
									WHEN count(rdr.RegistryDataRecept_id) > 0 
											AND count(rdr.RegistryDataRecept_id) = sum(case when yn.YesNo_Code = 1 then 1 else 0 end)
									THEN 2 ELSE 1
								END
							from
								{$this->schema}.RegistryDataRecept rdr
								left join v_YesNo yn on yn.YesNo_id = rdr.RegistryDataRecept_IsReceived
								left join {$this->schema}.v_ReceptStatusFLKMEK rsfm on rsfm.ReceptStatusFLKMEK_id = rdr.ReceptStatusFLKMEK_id
							where
								Registry_id = (select Registry_id from {$this->schema}.RegistryDataRecept where RegistryDataRecept_id = :RegistryDataRecept_id) and
								rsfm.ReceptStatusFLKMEK_Code = 5; -- Принят к оплате
							)
						limit 1
					)
				where
					Registry_id = (select Registry_id from {$this->schema}.RegistryDataRecept where RegistryDataRecept_id = :RegistryDataRecept_id);
		";
		$p = array(
			'RegistryDataRecept_id' => $data['RegistryDataRecept_id']
		);
