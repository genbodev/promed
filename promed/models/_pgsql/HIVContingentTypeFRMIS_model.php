 ...
 * @version
 */
class HIVContingentTypeFRMIS_model extends swPgModel {
	...
	public function getAll() {
		$query = 'select
				HIVContingentTypeFRMIS_id as "HIVContingentTypeFRMIS_id",
				HIVContingentTypeFRMIS_Code as "HIVContingentTypeFRMIS_Code",
				HIVContingentTypeFRMIS_Name as "HIVContingentTypeFRMIS_Name"
