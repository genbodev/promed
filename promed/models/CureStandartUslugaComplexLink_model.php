 ...
 */
class CureStandartUslugaComplexLink_model extends swModel
{
	/**
	...
	function updateLinks($data)
	{
		...
		$result = $this->db->query("select * from {$this->viewName()} with (nolock)
		...
		$result = $this->db->query("
			...
			from
				v_UslugaComplex lab with (nolock)
				...
				inner join CSU with(nolock) on item.UslugaComplex_2011id = CSU.UslugaComplex_id
