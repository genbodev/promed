...
class Cmp110_model extends swModel {
	...
	public function getAttributeListDataByCode($code){
		$sql = "
			...
			FROM
				Cmp110Attribute as ca_parent with(nolock)
				INNER JOIN Cmp110Attribute as ca_child with(nolock) ON(ca_child.Cmp110Attribute_pid=ca_parent.Cmp110Attribute_id)
			WHERE
