...
class Ufa_BSK_Register_User_model extends swModel
{
        ...
        $query = "select 
                ...
                outer apply(
                 select top 1 
						...
						R.BSKRegistry_id
                 from r2.BSKRegistry R with (nolock) 
    ...
    function getLastAnketData($data){
        ...
        $query = "select *  from r2.getLastAnketData (:Person_id)";
    ...
    function getMOforOKS(){
        ...
        $query = "
            ...
            as 
            (
            	select AMO.withSTLpu_id as Lpu_id from r2.AreaofResponsibilityMO AMO with(nolock) where isnull(AMO.withSTLpu_id, 0) > 0
            	union all
            	select AMO.nwithoutSTLpu_id as Lpu_id from r2.AreaofResponsibilityMO AMO with(nolock) where isnull(AMO.nwithoutSTLpu_id, 0) > 0
            	union all
            	select AMO.CHKVLpu_id as Lpu_id from r2.AreaofResponsibilityMO AMO with(nolock) where isnull(AMO.CHKVLpu_id, 0) > 0
            )
            select 
            	Lpu.Lpu_id, 
            	Lpu.Org_Nick 
    ...
    function getOKSdata($data){
        ...
        $query = "  
            ...
            from r2.BSKRegistryData with(nolock)
    ...
    */
    function getRecomendationOKS($data){
        ...
        $query = "
            ...
            from 
                r2.BSKObservRecomendation with(nolock)
            where 
    ...
    */
    ...
    function getContraindicationsTLT($data){
        ...
        $query = "
             ...
             from r2.BSKObservRecomendation with(nolock) where BSKObservRecomendationType_id = :BSKObservRecomendationType_id
        ";
    ...
    function getReferenceECGResult($data){
        ...
        $query = "select 
                    ...
                    subgroupOKC 
                from 
                    r2.ReferenceECGResult with(nolock)
                where 
                    KLrgn_id = :KLrgn_id 
    ...
    function getDrugs($data)
    {
        ...
        $query = "
            ...
            CONVERT(char(10), RD.BSKRegistryData_insDT,104) as BSKRegistryData_insDT
             from r2.BSKRegistryData RD  with(nolock)
            left join r2.BSKRegistry R with(nolock) on RD.BSKRegistry_id = R.BSKRegistry_id
            left join r2.BSKObservElement E with(nolock) on RD.BSKObservElement_id = E.BSKObservElement_id
            left join r2.BSKObservElementGroup EG with(nolock) on E.BSKObservElementGroup_id = EG.BSKObservElementGroup_id
    ...
    function getComboUnits($data)
    {
        ...
        if (empty($BSKObservUnits_ids)) {
            $query = "select BSKObservUnits_id, BSKObservUnits_name from r2.BSKObservUnits with(nolock)";
        } else {
            $query = "select BSKObservUnits_id, BSKObservUnits_name from r2.BSKObservUnits with(nolock) where BSKObservUnits_id in (" . implode(',', $BSKObservUnits_ids) . ")";
        }
    ...
    function getRecomendationByDate($data)
    {
        ...
        $query = "
            ...
            exec r2.p_getRecomendationByDate
    ...
    function getTreeDatesRecomendations($data)
    {
        ...
        $query = "
            select 
                ...
                'true' as leaf             
            from r2.BSKRegistry with(nolock) 
                ...
                if (trim($value) != '' || $registryData['MorbusType_id'] == 19) {
                    ...
                    $query = "
                        declare
                            ...
                            @Error_Code bigint,
                            @Error_Message varchar(4000);
                        exec r2.p_BSKRegistryData_insNEW
    ...
    function checkRegisterDate($data)
    {
        ...
        $query = " select *
            from r2.BSKRegistry with(nolock) where MorbusType_id = :MorbusType_id
    ...
    function getRegistryDates($data)
    {
        ...
        $query = "
            select * from r2.BSKRegistry with(nolock) 
            where MorbusType_id = :MorbusType_id and Person_id = :Person_id
    ...
    function preSaveRegistryData($data)
    {
        ...
        $query = "select 
                ...
                from r2.BSKObservElementValues V with(nolock)
                left join r2.BSKObservElement E with(nolock) on E.BSKObservElement_id = V.BSKObservElement_id 
    ...
    function getWaistPercentel($data)
    {
        ...
        $query = "
            select top 1 PercentileWaist_Percentile as prc from r2.PercentileWaist with(nolock)
            where 
    ...
    function getAnketsData($data)
    {
        ...
        $query = "
            ...
            from r2.BSKObservElementValues V with(nolock)
            inner join r2.BSKObservElement E with(nolock) on E.BSKObservElement_id = V.BSKObservElement_id 
                       and E.BSKObservElement_deleted = 1
                       and E.BSKObservElement_stage = 1
            inner join r2.BSKObservElementGroup G with(nolock) on G.BSKObservElementGroup_id = E.BSKObservElementGroup_id 
                       and 1=1
            inner join r2.BSKObservElementLink L with(nolock) on L.BSKObservElement_id = E.BSKObservElement_id
    ...
    function updateRegistry($data, $registryData)
    {
        ...
        $q = 'SELECT BSKRegistryData_id, BSKObservElement_id FROM r2.BSKRegistryData with(nolock) WHERE BSKRegistry_id = :BSKRegistry_id';
    ...
    function getLastVizitRegistry($data)
    {
        ...
        if ($data['BSKRegistry_id'] == null) {
            $query = "
                 ...
                 R.BSKRegistry_riskGroup,
                 (select BSKObservElementFormat_id from r2.BSKObservElement E with(nolock) where E.BSKObservElement_id = RD.BSKObservElement_id) as BSKObservElementFormat_id
                 from r2.BSKRegistryData RD with(nolock)
                 left join r2.BSKRegistry R with(nolock) on R.BSKRegistry_id = RD.BSKRegistry_id
                 where R.Person_id = :Person_id and R.MorbusType_id = :MorbusType_id 
                 and R.BSKRegistry_id = (select top 1 BSKRegistry_id from r2.BSKRegistry R with(nolock) where R.Person_id = :Person_id and R.MorbusType_id = :MorbusType_id  order by R.BSKRegistry_setDate DESC )
             ";
        } else {
            $query = "
                 select *, 
    ...
    function addRegistryData($data)
    {
        ...
        $query = "
                ...
                left join r2.BSKObject BO with(nolock) on BO.BSKObject_id = L.BSKObject_id
                -- конец финта
    ...
    function loadPersonData($data)
    {
        ...
        $query  = "
			SELECT TOP 1
				ps.Person_id,
                (select top 1 BSKRegistry_riskGroup from r2.BSKRegistry with(nolock) where MorbusType_id = 84 and Person_id =  ps.Person_id order by BSKRegistry_setDate DESC) as BSKRegistry_riskGroup,
                
                (select BSKRegistryData_data from r2.BSKRegistryData with(nolock) where BSKRegistry_id = 
                (
                select top 1 BSKRegistry_id from r2.BSKRegistry with(nolock) 
                where 
    ...
    function getLpuType($data) {
        ...
        $query = "
            select top 1 LpuType_id from v_Lpu where Lpu_id = :Lpu_id
        "; 
    ...
    function getOksId($data) {
        ...
        $query = 'SELECT TOP 1
                    ...
                    FROM
                        ...
                        outer apply (select BSKRegistry_id from r2.BSKRegistryData with(nolock) where BSKObservElement_id = 398 and BSKRegistryData_data = :EvnPS_NumCard) BRD
                    WHERE
