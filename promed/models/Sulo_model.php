...
class Sulo_model extends swModel
{
	/**
	 *	Конструктор
	 */	
    ...
    */
    function AddRegisterToSyncronLog($id)
    {
    	$query = "
			declare
				@ObjectSynchronLog_id bigint = null,
				@Object_setDT datetime = dbo.tzGetDate(),
				@ErrCode int,
				@ErrMessage varchar(4000);

			exec p_ObjectSynchronLog_ins
			...
			select @ObjectSynchronLog_id as ObjectSynchronLog_id, @ErrCode as Error_Code, @ErrMessage as Error_Msg;
		";
