<?php
/**
 * Buryatiya_Wialon_model - модель для работы с Wialon
 *
...
class Buryatiya_Wialon_model extends Wialon_model {
	/**
	 * @var string Хост с изображениями
	 */
	//protected $_image_host = 'http://wialon.burmed.ru:8022';
	protected $_image_host = WIALON_IMAGE_HOST;

	/**
	 * @var stting Wialon API URL
	 */
	//protected $_api_url = 'http://wialon.burmed.ru/wialon/ajax.html';
	...
	public function login($credentials = array()){
		$standard_token = '3646e3d33894e4b8e370d13ddd327dbf92265F84FD99B84074DC465D728EF69A25C7C919';
