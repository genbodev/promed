...
class BactMicro_model extends Collection_model {
	...
	function getElementParentList($params) {
		$query = "declare @BactMicro_id  bigint = :BactMicro_id;
