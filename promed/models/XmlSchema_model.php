 ...
 */
class XmlSchema_model extends swModel
{
	/**
	 * Пользователь
	 * @var integer
	...
	public function save($data = array())
	{
		...
		$sql = "
			declare
				...
				@ErrCode int,
				@ErrMsg varchar(4000);
			set @XmlSchema_id = :XmlSchema_id;
			exec {$procedure}
				@XmlSchema_id = @XmlSchema_id output,
				@XmlSchema_Data = :XmlSchema_Data,
				@pmUser_id = :pmUser_id,
				@Error_Code = @ErrCode output,
				@Error_Message = @ErrMsg output;
			select @XmlSchema_id as XmlSchema_id, @ErrCode as Error_Code, @ErrMsg as Error_Msg;
		";
