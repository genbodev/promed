...
<html>
<head>
<title>Печать списка ТАП (стоматология)</title>
<style type="text/css">
...
<td style="text-align: center;">{EvnPLStom_NumCard}</td>
<td>{Person_Surname}</td>
<td>{Person_Firname}</td>
<td>{Person_Secname}</td>
<td style="text-align: center;">{Person_Birthday}</td>
<td style="text-align: right;">{EvnPLStom_VizitCount}</td>
<td>{EvnPLStom_IsFinish}</td>
<td>{MedPersonal_Fio}</td>
<td style="text-align: center;">{EvnPLStom_setDate}</td>
<td style="text-align: center;">{EvnPLStom_disDate}</td>
</tr>
{/search_results}
