...
<table style="width: 100%; border: none; border-collapse: collapse;" cellspacing="0" cellpadding="2">
<tbody>
<tr style="background-color: #eee; font-weight: bold; text-align: center;">
	<td style="width: 1%;" nowrap>№ п/п</td>
	<td style="width: 10%;">№ карты</td>
	<td style="width: 14%;">Фамилия</td>
	<td style="width: 14%;">Имя</td>
	<td style="width: 14%;">Отчество</td>
	<td style="width: 8%;">Дата рождения</td>
	<td style="width: 8%;">Поступление</td>
	<td style="width: 8%;">Диагноз</td>
