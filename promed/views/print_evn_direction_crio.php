...
<html>
<head>
<title>Печать направления на процедуру переноса эмбриона</title>
<style type="text/css">
...
<div style="text-align: right; margin-bottom: 3em;">
    <div>Приложение 13 к приказу</div>
...
<div style="text-align: center; margin: 1em 0em 3em 0em; font-weight: bold;">
	<div>НАПРАВЛЕНИЕ</div>
	<div>для проведения процедуры переноса криоконсервированного эмбриона за счет средств обязательного медицинского страхования</div>
</div>

<table style="width: 100%; border: none;" cellspacing="0" cellpadding="0">
    <tbody><tr>
        <td style="width: 50%;">№ {EvnDirectionCrio_Num}</td>
        <td style="width: 50%; text-align: right;">{EvnDirectionCrio_setDate}</td>
    </tr></tbody>
</table>
...
<div style="text-align: center; margin: 1em 0em 3em 0em;">
    ...
    <div class="small">(ФИО пациента, направляемого для проведения процедуры переноса криоконсервированного эмбриона)</div>
...
<div style="text-align: right; margin: 1em 0em 3em 0em;">
    <div>Приложение 14 к приказу</div>
    <div>Министерства здравоохранения Пермского края</div>
    <div>от 31 мая 2018 года № СЭД-34-01-06-418</div>
</div>

<div style="text-align: center; margin: 1em 0em 3em 0em; font-weight: bold;">
    <div>Сведения о медицинской организации, выполнившей процедуру переноса криоконсервированного эмбриона за счет средств ОМС</div>
</div>
...
<div style="text-align: center; margin: 1em 0em 3em 0em;">
    ...
    <div class="small">(наименование медицинской организации, выполнившей процедуру криопереноса)</div>
    <div style="border-bottom: 1px solid black; margin-top: 1em;">{Person_Birthday}, {Person_Age}</div>
    <div class="small">(шифр пациента) (дата рождения) (возраст пациента)</div>
    <div style="border-bottom: 1px solid black; margin-top: 1em;">&nbsp;</div>
    <div class="small">(период проведения криопереноса) (результат проведенного лечения)</div>
</div>
