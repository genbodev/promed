...
<table style="width: 100%;"><tr>
    ...
    <td>10. Социальный статус: 
        <span<?php if($SocStatus_Code==3 || $SocStatus_Code==10 || $SocStatus_Code==16) { echo " class='line'"; }?> >дошкольник – 1</span>;
        <span>организован – 2</span>;
        <span>неорганизован – 3</span>;
        <span<?php if($SocStatus_Code==4 || $SocStatus_Code==11) { echo " class='line'"; }?> >учащийся – 4</span>;
        <span<?php if($SocStatus_Code==1) { echo " class='line'"; }?> >работает – 5</span>;
        <span<?php if($SocStatus_Code==5) { echo " class='line'"; }?> >не работает – 6</span>;
        <span>БОМЖ – 7</span>;  
        <span<?php if($SocStatus_Code==2) { echo " class='line'"; }?> >пенсионер – 8</span>;
        <span> >военнослужащий – 9</span>;
        <span>код - ________</span>; 
        <span>Член семьи военнослужащего – 10</span>.
    </td>
</tr></table>
