...
<table style="width: 100%;"><tr>
    ...
    <td>10. Социальный статус: 
        <span<?php if($SocStatus_Code==1) { echo " class='line'"; }?> >дошкольник - 1</span>;
        <span<?php if($SocStatus_Code==2) { echo " class='line'"; }?> >учащийся - 4</span>; 
        <span<?php if($SocStatus_Code==3) { echo " class='line'"; }?> >работает - 5</span>;
        <span<?php if($SocStatus_Code==4 || $SocStatus_Code==11) { echo " class='line'"; }?> >не работает - 6</span>;
        <span<?php if($SocStatus_Code==5) { echo " class='line'"; }?> >пенсионер - 8</span>;
