...
<table style="width: 100%;"><tr>
    ...
    <td>10. Социальный статус: 
        <span<?php if($SocStatus_Code==1 || $SocStatus_Code==2) { echo " class='line'"; }?> >дошкольник - 1</span>;
        <span<?php if($SocStatus_Code==2) { echo " class='line'"; }?> >организован - 2</span>; 
        <span<?php if($SocStatus_Code==1) { echo " class='line'"; }?> >неорганизован - 3</span>; 
        <span<?php if($SocStatus_Code==3) { echo " class='line'"; }?> >учащийся - 4</span>; 
        <span<?php if($SocStatus_Code==4 || $SocStatus_Code==10) { echo " class='line'"; }?> >работает - 5</span>; 
        <span<?php if($SocStatus_Code==5 || $SocStatus_Code==6) { echo " class='line'"; }?> >не работает - 6</span>; 
        <span<?php if($SocStatus_Code==9) { echo " class='line'"; }?> >БОМЖ - 7</span>; 
        <span<?php if($SocStatus_Code==6 || $SocStatus_Code==10) { echo " class='line'"; }?> >пенсионер - 8</span>; 
        <span<?php if($SocStatus_Code==7) { echo " class='line'"; }?> >военнослужащий - 9</span>; 
        <span>код - _______</span>; 
        <span<?php if($SocStatus_Code==8) { echo " class='line'"; }?> >член семьи военнослужащего - 10</span>
    </td>
</tr></table>
