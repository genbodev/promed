...
<td style="text-align: center;">{EvnPLDispTeen14_setDate}</td>
<td style="text-align: center;">{EvnPLDispTeen14_disDate}</td>
<td style="text-align: right;">{EvnPLDispTeen14_VizitCount}</td>
<td>{EvnPLDispTeen14_IsFinish}</td>
</tr>
{/search_results}
