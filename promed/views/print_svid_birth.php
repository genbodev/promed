...
<div style="text-align: left; margin-bottom:1em;">
	1. Ребенок родился: число {BirthSvid_BirthDateDay}, месяц {BirthSvid_BirthDateMonth}, год {BirthSvid_BirthDateYear}, час {BirthSvid_BirthTimeHour}, мин.{BirthSvid_BirthTimeMin}<br/>
	...
	4. Место постоянного жительства (регистрации) матери ребенка: республика, край, область {KLRGN_Name}<br/>
	<table style="margin-left:1em; width:100%;">
		<tr>
			<td>район {KLSubRGN_Name}</td>
			<td>город {KLCity_Name}</td>
			<td style="width:45%;">населенный пункт {KLTown_Name}</td>
		</tr>
	</table>	
	<table style="margin-left:1em; width:100%;">
		<tr>
...
<div class="cutline" style="margin-top:10em;">Линия отреза</div>
</div>
...
<td style="border: 1px black dotted; vertical-align:top;">
	<table style="width:100%;">
        ...
        <!--<tr><td colspan="2">Номер и дата выдачи лицензии на осуществление медицинской</td></tr>
        <tr><td>деятельности</td><td>{LpuLicence_Num} от {LpuLicence_setDate}</td></tr>-->
...
<tr>
	...
	<td style="font-weight: bold; text-align: center;">Ребенок</td>
</tr>
<tr>
	...
	<td style="border: 1px black solid; vertical-align: top;">
		<table class="ct ctleft" style="margin-bottom:3em;">
			<tr><td class="small">11.</td><td>Фамилия ребенка</br>{BirthSvid_ChildFamil}</td></tr>
...
<tr style="page-break-before: always;">
	<td colspan="2">
		...
		<table style="margin-top:1em; margin-bottom:5.2em;" class="ct ctcenter">
			...
			<tr><td></td><td colspan="5">(фамилия, имя, отчество и отношение к ребенку)</td></tr>
			<tr><td></td><td colspan="5" class="tleft dashed">{BirthSvid_RcpDocument}</td></tr>
			<tr><td></td><td colspan="5">(документ, удостоверяющий личность получателя, серия, номер, кем выдан;</td></tr>
			<tr><td></td><td colspan="5" class="tleft dashed">&nbsp;</td></tr>
			<tr><td></td><td colspan="5" style="padding-bottom:5em;">документ, удостоверяющий полномочия получателя)</td></tr>
...
<tr>
	...
	<td style="border: 1px black solid; border-top-style: none; vertical-align: top;">
		16. Масса тела ребенка при рождении: {BirthSvid_Mass} <!--{Okei_mid_Okei_NationSymbol}-->г</br>
		17. Длина тела ребенка при рождении: {BirthSvid_Height} см.</br>			
		</br>
		18. Ребенок родился:</br>
			при одноплодных родах <input type="checkbox" {BirthSvid_IsMnogoplod_Checked} onClick="return false;"/></br>
			при многоплодных родах: которым по счету {BirthSvid_PlodIndex}</br>
