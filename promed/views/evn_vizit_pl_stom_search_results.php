...
<tr style="background-color: #eee; font-weight: bold; text-align: center;">
	...
	<td style="width: 7%;">Дата рождения</td>
	<td style="width: 13%;">Основной диагноз</td>
	<td style="width: 10%;">Отделение</td>
	<td style="width: 13%;">Врач</td>
	...
	<td style="width: 5%;">Количество УЕТ</td>
</tr>
<tr style="background-color: #eee; font-weight: bold; text-align: center;">
	<td>1</td>
	<td>2</td>
...
<td style="text-align: center;">{EvnVizitPLStom_setDate}</td>
<td>{ServiceType_Name}</td>
<td>{VizitType_Name}</td>
<td>{PayType_Name}</td>
<td>{EvnVizitPLStom_Uet}</td>
</tr>
{/search_results}
