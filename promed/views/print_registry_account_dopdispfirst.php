...
<tr><td>&nbsp;</td><td>&nbsp;</td></tr>
<tr><td>Назначение платежа</td><td>За медицинские услуги по диспансеризации определённых групп взрослого населения за период, оказанные в {Month} {Year} года</td></tr>
<tr><td>&nbsp;</td><td>&nbsp;</td></tr>
</table>
...
<tr>
	<td style="border: 1px solid #000; padding: 1em; text-align: left;">За медицинские услуги по диспансеризации определённых групп взрослого населения за период, оказанные в {Month} {Year} года</td>
	<td style="border: 1px solid #000; padding: 1em; text-align: right;">{Registry_SumPaid}</td>
</tr>
</table>

<div style="padding: 2em 1em 1em 0em;">ИТОГО</div>

<div style="padding: 1em 1em 2em 0em;">{Registry_SumPaid_Words}</div>
