...
<tr><td>6.</td><td>Местность: <span class="val_1">город</span> - 1, <span class="val_2">село</span> - 2 <div class="selector">{KlareaType_id}</div></td></tr>
...
<tr><td>8.</td><td>Местность: <span class="val_1">город</span> - 1, <span class="val_2">село</span> - 2 <div class="selector">{DKlareaType_id}</div></td></tr>
...
<tr><td>11.</td><td> Для детей, умерших в возрасте от 168 часов до 1 года: масса тела ребёнка при рождении <nobr>{DeathSvid_Mass} грамм - 1,</nobr> число месяцев каким по счёту был ребёнок у матери <nobr>(считая умерших и несчитая мертворожденных) {DeathSvid_ChildCount} - 2,</nobr> дата рождения <nobr>матери {DeathSvid_MotherBirthday} - 3,</nobr> возраст <nobr>матери {DeathSvid_MotherAge} - 4,</nobr> фамилия <nobr>матери {DeathSvid_MotherFamaly} - 5,</nobr> <nobr>имя {DeathSvid_MotherName} - 6,</nobr> <nobr>отчество {DeathSvid_MotherSecName} - 7.</nobr></td></tr>
<tr><td>12.</td><td>*Семейное положение: <span class="val_1">состоял(а) в <nobr>браке</span> - 1,</nobr> <span class="val_2">никогда не состоял(а) в <nobr>браке</span> - 2,</nobr>  <nobr><span class="val_3">вдовец (вдова)</span> - 3,</nobr> <nobr><span class="val_4">разведен(а)</span> - 4,</nobr> <nobr><span class="val_5">неизвестно</span> - 5.</nobr><div class="selector">{DeathFamilyStatus_Code}</div></td></tr>
...
<tr style="page-break-before: always;"><td colspan="2">
	<table class="ct ctleft">
		<tr><td class="small">10.</td><td colspan="2">Причины смерти:</td><td colspan="3" class="tcent" style="border-left-style: dashed; border-right-style: dashed;">Приблизительный</br>период времени</br>между началом</br>патологического</br>процесса и смерти</td><td rowspan="9" class="small">&nbsp;</td><td colspan="5">&nbsp;</td></tr>
...
<tr><td>16.</td><td> В случае смерти от несчастного случая, убийства, самоубийства, от военных и террористических действий, при неустановленном роде смерти - указать дату травмы (отравления): {DeathSvid_TraumaDate_Date}, время {DeathSvid_TraumaDate_Time}</br>
	Место и обстоятельства, при которых произошла травма (отравление):</br>																																																	
...
<tr><td colspan="2">
	<table class="ct ctleft">
		<tr><td class="small"></br>19.</td><td colspan="2"> смерти:</br>Причины смерти:</td><td colspan="3" class="tcent" style="border-left-style: dashed; border-right-style: dashed;">Приблизительный</br>период времени</br>между началом</br>патологического</br>процесса и смерти</td><td rowspan="9" class="small">&nbsp;</td><td colspan="5">&nbsp;</td></tr>
		<tr><td rowspan="8">I.</td><td rowspan="2" class="small">а)</td><td class="dashed">{Diag1_Name}</td><td rowspan="8" class="small" style="border-left-style: dashed;">&nbsp;</td><td class="dashed tcent">&nbsp;</td><td rowspan="8" class="small" style="border-right-style: dashed;">&nbsp;</td><td class="diat">{D11}</td><td class="diat">{D12}</td><td class="diat">{D13}</td><td class="diat">{D14}</td><td class="diat">{D15}</td></tr>
		<tr><td class="tcent">(болезнь или состояние непосредственно приведшее к смерти)</td><td>&nbsp;</td><td colspan="5">&nbsp;</td></tr>			
		<tr><td rowspan="2">б)</td><td class="dashed">{Diag2_Name}</td><td class="dashed tcent">&nbsp;</td><td class="diat">{D21}</td><td class="diat">{D22}</td><td class="diat">{D23}</td><td class="diat">{D24}</td><td class="diat">{D25}</td></tr>
		<tr><td class="tcent">(патологическое состояние, которое привело к возникновению вышеуказанной причины)</td><td>&nbsp;</td><td colspan="5">&nbsp;</td></tr>
