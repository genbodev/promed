...
<tr style="background-color: #eee; font-weight: bold; text-align: center;">
	...
	<td style="width: 5%;">кол-во уп., отпущенных АУ</td>
	...
	<td style="width: 5%;">Время обращения</td>
	<td style="width: 5%;">Дата отсрочки</td>
	<td style="width: 5%;">Дата отоваривания</td>
</tr>
<tr style="background-color: #eee; font-weight: bold; text-align: center;">
	<?php for($i=1; $i!=29; $i++) {
		echo "<td>".$i."</td>";
...
<td style="text-align: center;">{EvnRecept_secKolvo}</td>
