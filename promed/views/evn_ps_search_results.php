...
<tr style="background-color: #eee; font-weight: bold; text-align: center;">
	...
	<td style="width: 3%;">№ карты</td>
	<td style="width: 10%;">Фамилия</td>
	<td style="width: 10%;">Имя</td>
	<td style="width: 15%;">Отчество</td>
	<td style="width: 6%;">Дата рождения</td>
	<td style="width: 6%;">Поступление</td>
	<td style="width: 6%;">Выписка</td>
	<td style="width: 10%;">Отделение</td>
	<td style="width: 15%;">Диагноз</td>
	<td style="width: 3%;">К/дни</td> 
	<td style="width: 2%;">БДЗ</td>
	<td style="width: 5%;">Вид оплаты</td>
	<td style="width: 16%;">Исход</td>
</tr>
<tr style="background-color: #eee; font-weight: bold; text-align: center;">
	<td>1</td>
	<td>2</td>
...
<td style="text-align: right;">{EvnPS_NumCard}</td>
