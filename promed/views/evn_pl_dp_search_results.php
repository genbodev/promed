...
<tr style="background-color: #eee; font-weight: bold; text-align: center;">
	...
	<td style="width: 5%;">Дата отказа профосмотра</td>
	<td style="width: 5%;">Дата начала профосмотра	</td>
	<td style="width: 5%;">Дата окончания профосмотра</td>
	<td style="width: 5%;">Профосмотр закончен</td>
	<td style="width: 5%;">Группа здоровья</td>
</tr>
<tr style="background-color: #eee; font-weight: bold; text-align: center;">
	<td>1</td>
	<td>2</td>
...
<td>{EvnPLDispProf_setDate}</td>
<td>{EvnPLDispProf_setDate}</td>
<td>{EvnPLDispProf_disDate}</td>
<td>{EvnPLDispProf_IsEndStage}</td>
<td>{EvnPLDispProf_HealthKind_Name}</td>
</tr>
{/search_results}
