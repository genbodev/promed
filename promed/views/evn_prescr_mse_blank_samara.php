...
<table width="100%">
	<tr>
		<td width="60%"></td>
		<td>к Приказу Министерства здравоохранения и социального развития Российской Федерации от 31 января 2007 г. № 77 <br> Форма № 088/у-06</td>
	</tr>
</table>
...
<p style="padding: 5px;">
	Дата выдачи: <mark>{EvnPrescrMse_setDate}</mark><br />
	...
	7. Степень ограничения способности к трудовой деятельности:<br/>
	...
	<p align="center"><mark>{EvnPrescrMse_MedRes}</mark></p>
	...
	б) основное заболевание: <mark>{diag1_FullName}</mark><br />
	...
	программы реабилитации инвалида, программы реабилитации пострадавшего в результате
...
<table class="ct ctcenter">
	<tr><*> Не позднее одного месяца со дня выдачи настоящее направление может быть представлено гражданином (его законным представителем) в филиал главного бюро медико-социальной
	экспертизы - бюро медико-социальной экспертизы.</tr>
</table>
