...
<td>{PrivilegeTypeWOW_Name}</td>
<td style="text-align: center;">{EvnPLWOW_setDate}</td>
<td style="text-align: center;">{EvnPLWOW_disDate}</td>
<td style="text-align: right;">{EvnPLWOW_VizitCount}</td>
<td>{EvnPLWOW_IsFinish}</td>
</tr>
{/search_results}
