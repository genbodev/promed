...
<td class="cell">{StickIrregularity_Name}</td>
...
{EvnStickWorkReleaseData}
<tr>
<td class="cell">{EvnStick_SerNum}</td>
<td class="cell">{EvnStickWorkRelease_begDate}</td>
<td class="cell">{EvnStickWorkRelease_endDate}</td>
