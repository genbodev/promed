...
<tr><td colspan="6" style="font-weight: bold;">
	<div>Пациент: {Person_Fio}</div>
	<div>Дата рождения: {Person_Birthday}</div>
	<div>Адрес: {UAddress_Name}</div>
	<div>ЛПУ прикрепления: {AttachLpu_Name}</div>
</td></tr>
{drug_list}
<tr>
...
{drug_request_reserve_data}
<tr><td colspan="6" style="background-color: #eee; font-weight: bold;">РЕЗЕРВ</td></tr>
{drug_reserve_list}
<tr>
