...
<td style="border-right: 1px dashed #000; padding-right: 5px; height: 100%; width: 50%;">
...
<div style="position: absolute; top: 525; left: 85; width: 220; font-weight: bold; font-size: 10px;">{signa}</div>
...
<div style="position: absolute; top: 600; left: 365;">М.П. </div>
...
<div style="position: absolute; top: 75; left: 550; width: 160;">
  <div>Код ОГРН</div>
	<table width="100%" cellspacing="0" cellpadding="0">
		<tr style="text-align: center;">
			<td style="width: 6.6%; border: 1px solid #000; font-size: 10px;">{lpu_ogrn_0}</td>
...
<div style="position: absolute; top: 190; left: 550; width: 500;">
  <table width="100%" cellspacing="0" cellpadding="0"><tr>
    <td style="width: 12%; font-weight: bold;">РЕЦЕПТ</td>
    <td style="width: 9%;">Серия</td>
    <td style="width: 19%; font-weight: bold; font-size: 10px; text-decoration: underline;">{recept_ser}</td>
...
<div style="position: absolute; top: 205; left: 550; width: 500;">
  <table width="100%" cellspacing="0" cellpadding="0"><tr>
    <td style="width: 17%; vertical-align: bottom;">Ф.И.О. пациента</td>
    <td style="width: 83%; font-weight: bold; font-size: 12px; border-bottom: 1px solid #000;">&nbsp; {person_fio}</td>
  </tr></table>
...
<div style="position: absolute; top: 230; left: 550;">Дата рождения</div>

<div style="position: absolute; top: 228; left: 630; width: 150;">
  <table width="100%" cellspacing="0" cellpadding="0">
  <tr style="text-align: center; font-weight: bold;">
    <td style="width: 10%; border: 1px solid #000; font-size: 10px;">{person_birthday_1}</td>
    <td style="width: 10%; border: 1px solid #000; font-size: 10px;">{person_birthday_2}</td>
...
<div style="position: absolute; top: 230; left: 790;">СНИЛС</div>

<div style="position: absolute; top: 228; left: 820; width: 230;">
  <table width="100%" cellspacing="0" cellpadding="0">
  <tr style="text-align: center; font-weight: bold;">
    <td style="width: 7%; border: 1px solid #000; font-size: 10px;">{person_snils_1}</td>
    <td style="width: 7%; border: 1px solid #000; font-size: 10px;">{person_snils_2}</td>
...
<div style="position: absolute; top: 250; left: 550; width: 130;">№ полиса обязательного медицинского страхования</div>

<div style="position: absolute; top: 250; left: 690; width: 360;">
  <table width="100%" cellspacing="0" cellpadding="0">
  <tr style="text-align: center;">
    <td class="polis_ser_num">{polis_ser_num_1}</td>
    <td class="polis_ser_num">{polis_ser_num_2}</td>
...
<div style="position: absolute; top: 275; left: 550; width: 300;">{str_amb_header}</div>

<div style="position: absolute; top: 275; left: 900; width: 150; border-bottom: 1px solid #000; text-align: center; font-size: 10px;">{ambul_card_num}</div>
...
<div style="position: absolute; top: 295; left: 550; width: 500; border-bottom: 1px solid #000; font-size: 10px;">&nbsp; {address_string_1} {address_string_2}</div>

<div style="position: absolute; top: 335; left: 550;">Ф.И.О. лечащего врача</div>

<div style="position: absolute; top: 330; left: 690; width: 360; border-bottom: 1px solid #000; font-size: 12px;">&nbsp; {medpersonal_fio}</div>

<div style="position: absolute; top: 355; left: 550; width: 250;">
  <table width="100%" cellspacing="0" cellpadding="0">
  <tr style="text-align: center;">
    <td style="width: 34%; text-align: left;">Код лечащего врача</td>
    <td style="width: 6%; border: 1px solid #000; font-size: 10px;">{medpersonal_code_1}</td>
...
<div style="position: absolute; top: 380; left: 550;">Выписано:</div>

<div style="position: absolute; top: 390; left: 550; width: 245; border-bottom: 1px solid #000;">Rp:</div>

<div style="position: absolute; top: 405; left: 550; width: 245; height: 50; border-bottom: 1px solid #000; font-weight: bold; font-family: courier new; text-align: center; font-size: 10pt;">{drug_name}</div>

<div style="position: absolute; top: 460; left: 550;">D.t.d.</div>

<div class="drugform" style="position: absolute; top: 458; left: 635; width: 170; font-size: {drug_form_length};  line-height: {drug_form_line_height};">{drug_form}</div>

<div style="position: absolute; top: 485; left: 550;">Дозировка</div>

<div style="position: absolute; top: 483; left: 635; width: 195; font-weight: bold; font-size: 7pt;">{drug_dose}</div>

<div style="position: absolute; top: 505; left: 550;">Количество единиц</div>

<div style="position: absolute; top: 503; left: 635; width: 165; font-weight: bold; font-size: 10px;">{drug_kolvo}</div>

<div style="position: absolute; top: 525; left: 635; width: 220; font-weight: bold; font-size: 10px;">{signa}</div>

<div style="position: absolute; top: 520; left: 550; width: 245; border-top: 1px solid #000;">Signa</div>

<div style="position: absolute; top: 550; left: 550; width: 245; border-top: 1px solid #000;">
  Подпись лечащего врача и личная<br />
  печать лечащего врача
</div>
<div style="position: absolute; top: 595; left: 550; width: 245; border-top: 1px solid #000; "></div>
<div style="position: absolute; top: 355; left: 805; width: 245; border: 1px solid #000;">
  <div style="padding-top: 1px; text-align: center;">(заполняется специалистом аптечной организации)</div>
  <div style="padding-left: 5px; padding-right: 5px;">
    <div>Отпущено по рецепту:</div>
    <div style="border-bottom: 1px solid #000; height: 20px;">Дата отпуска</div>
...
<div style="position: absolute; top: 600; left: 915;">М.П. </div>

<div style="position: absolute; top: 615; left: 550; width: 500; border-bottom: 1px dashed #000; text-align: center;">(линия отрыва)</div>

<div style="position: absolute; top: 635; left: 550; width: 500; text-align: center;">
  Корешок РЕЦЕПТА &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  Серия &nbsp;&nbsp; <span style="font-weight: bold; font-size: 10px;">{recept_ser}</span> &nbsp;&nbsp;&nbsp;
  № &nbsp;&nbsp; <span style="font-weight: bold; font-size: 10px;">{recept_num}</span> &nbsp;&nbsp;&nbsp;
  от &nbsp;&nbsp; <span style="font-weight: bold; font-size: 10px;">{recept_date}</span>
...
<div style="position: absolute; top: 655; left: 550;">Способ применения:</div>

<div style="position: absolute; top: 670; left: 550; width: 245; border-bottom: 1px solid #000; padding-bottom: 1em;">Продолжительность</div>

<div style="position: absolute; top: 670; left: 770;">дней</div>

<div style="position: absolute; top: 700; left: 550; width: 245; border-bottom: 1px solid #000; padding-bottom: 1em;">Количество приемов в день:</div>

<div style="position: absolute; top: 700; left: 770;">раз</div>

<div style="position: absolute; top: 730; left: 550; width: 245; border-bottom: 1px solid #000; padding-bottom: 1em;">На 1 прием:</div>

<div style="position: absolute; top: 730; left: 770;">ед.</div>

<div style="position: absolute; top: 670; left: 805; width: 245; border-bottom: 1px solid #000; padding-bottom: 1em;">Наименование лекарственного препарата:</div>

<div style="position: absolute; top: 700; left: 805; width: 245; border-bottom: 1px solid #000; padding-bottom: 1em;">&nbsp;</div>

<div style="position: absolute; top: 730; left: 805; width: 245; border-bottom: 1px solid #000; padding-bottom: 1em;">Дозировка:</div>

<!--div style="position: absolute; top: 735; left: 550; width: 500; border-bottom: 1px dashed #000; text-align: center;">(линия отрыва)</div>

<div style="position: absolute; top: 745; left: 550; width: 500; text-align: center; font-weight: bold; font-size: 12px;">Наличие лекарственных препаратов:</div>

<div style="position: absolute; top: 760; left: 550; width: 500;">
...
<!--div style="position: absolute; top: 595; left: 550; width: 500; border-bottom: 1px dashed #000; text-align: center;">(линия отрыва)</div>

<div style="position: absolute; top: 615; left: 550; width: 500; text-align: center; font-weight: bold; font-size: 12px;">Наличие лекарственных препаратов:</div>

<div style="position: absolute; top: 630; left: 550; width: 500;">
  <div style="font-size: 12px; font-weight: bold;">Аптека: {orgfarmacy_name}</div>
  <div style="font-size: 12px; font-weight: bold;">Адрес: {orgfarmacy_howgo}</div>
  <div style="font-size: 12px; font-weight: bold;">Телефон: {orgfarmacy_phone}</div>
</div-->
...
<!-- ============================== ЭКЗЕМПЛЯР МО ============================== -->
<div style="position: relative; height: 730px; border: 1px solid #fff; top:50;">
...
<div style="position: absolute; top: 483; left: 85; width: 195; font-weight: bold; font-size: 7pt;">{drug_dose}</div>

<div style="position: absolute; top: 505; left: 0;">Количество единиц</div>

<div style="position: absolute; top: 503; left: 85; width: 165; font-weight: bold; font-size: 10px;">{drug_kolvo}</div>

<div style="position: absolute; top: 525; left: 85; width: 230; font-weight: bold; font-size: 10px;">{signa}</div>
