...
$is_krasnoyarsk = (isset($region_nick) && $region_nick == 'krasnoyarsk');
...
<div align='center'>
	...
	<?php if ($is_krasnoyarsk && $DirType_id == 10) { ?>
        <style type="text/css">
            .barcode-wrapper-top {
                padding-bottom: 5px;
                width: 100%;
            ...
            .r-directions-left-sided-top {
                float: right;
                display: block;
                clear: both;
            }

            .barcode-wrapper-top img {
                float: right;
                display: block;
                clear: both;
                width: 100px;
        ...
        <div class="barcode-wrapper-top">
            <p class="r-directions-left-sided-top">Направление №{EvnDirection_Num}</p>
