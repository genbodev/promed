...
<tr>
	<td style="border: 1px black solid; vertical-align: top;">
		<table class="ct ctleft">
			...
			<tr><td>8.</td><td>Семейное положение: <span class="val_1">состоит в зарегистрированном <nobr>браке</span> - 1,</nobr> <span class="val_2">не состоит в зарегистрированном <nobr>браке</span> - 2,</nobr> <span class="val_3">неизвестно</span> - 3 </nobr><div class="selector">{PntDeathFamilyStatus_Code}</div></td></tr>
	...
	<td style="border: 1px black solid; vertical-align: top;">
		<table class="ct ctleft">
			<tr><td class="small">12.</td><td>Фамилия ребёнка (плода)</br>{PntDeathSvid_ChildFio}</td></tr>
			...
			<tr><td>15.</td><td>Смерть (мертворождение) произошла(о): <span class="val_1">в <nobr>стационаре</span> - 1,</nobr> <nobr><span class="val_2">дома</span> - 2,</nobr>	<nobr><span class="val_3">в другом месте</span> - 3,</nobr> <nobr><span class="val_4">неизвестно</span> - 4. </nobr><div class="selector">{BirthPlace_id}</div></td></tr>
			...
			<tr><td>18.</td><td>Длина тела ребенка (плода) при рождении: {PntDeathSvid_Height} см.</td></tr>
...
<tr><td colspan="2">
	<table class="ct ctleft">
		<tr><td rowspan="11" class="small">11.</td><td colspan="2">Причины перинатальной смерти:</td><td rowspan="11" class="small">&nbsp;</td><td colspan="5">Код по МКБ-10</td></tr>
		<tr><td rowspan="2">а)</td><td>основное заболевание или патологическое состояние плода или ребенка</td><td class="diat">{D11}</td><td class="diat">{D12}</td><td class="diat">{D13}</td><td style="text-align: center">{D14}</td><td class="diat">{D15}</td></tr>
		<tr><td class="dashed">{Diag1_Name}</td><td colspan="5">&nbsp;</td></tr>			
		
		<tr><td rowspan="2">б)</td><td>другие заболевания или патологические состояния плода или ребёнка</td><td class="diat">{D21}</td><td class="diat">{D22}</td><td class="diat">{D23}</td><td style="text-align: center">{D24}</td><td class="diat">{D25}</td></tr>
		<tr><td class="dashed">{Diag2_Name}</td><td colspan="5">&nbsp;</td></tr>
		
		<tr><td rowspan="2">в)</td><td>основное заболевание или патологическое состояние матери, оказавшее неблагоприятное влияние на плод или ребёнка</td><td class="diat">{D31}</td><td class="diat">{D32}</td><td class="diat">{D33}</td><td style="text-align: center">{D34}</td><td class="diat">{D35}</td></tr>
		<tr><td class="dashed">{Diag3_Name}</td><td colspan="5">&nbsp;</td></tr>
		
		<tr><td rowspan="2">г)</td><td>другие заболевания или патологические состояния матери, оказавшее неблагоприятное влияние на плод или ребёнка</td><td class="diat">{D41}</td><td class="diat">{D42}</td><td class="diat">{D43}</td><td style="text-align: center">{D44}</td><td class="diat">{D45}</td></tr>
		<tr><td class="dashed">{Diag4_Name}</td><td colspan="5">&nbsp;</td></tr>
		
		<tr><td rowspan="2">д)</td><td>другие обстоятельства, имевшие отношение к мертворождению, смерти</td><td class="diat">{D51}</td><td class="diat">{D52}</td><td class="diat">{D53}</td><td style="text-align: center">{D54}</td><td class="diat">{D55}</td></tr>
		<tr><td class="dashed">{Diag5_Name}</td><td colspan="5">&nbsp;</td></tr>
	</table>
</td></tr>
<tr><td colspan="2">
	...
	<table class="ct ctcenter">
		...
		<tr><td></td><td class="tleft">(должность врача (фельдшера, акушерки), заполнившего</br>Медицинское свидетельство о перинатальной смерти)	</td><td>(подпись)</td><td>(фамилия, имя, отчество)</td></tr>
	</table>	
	...
	<table class="ct ctleft">
		<tr>
			...
			<td style="width:120px;" class="dashed">&nbsp;</td>
			<td style="padding-left:1em;">от "_______"___________________20____г.</td>
		</tr>
	</table>
	<table class="ct ctleft">
		<tr>
...
<tr><td>22.</td><td>Лицо, принимавшее роды: <nobr><span class="val_1">врач</span> - 1,</nobr> <span class="val_2">фельдшер, <nobr>акушерка</span> - 2,</nobr> <nobr><span class="val_3">другое</span> - 3 </nobr><div class="selector">{PntDeathGetBirth_id}</div></td></tr>
<tr><td colspan="2">
	<table class="ct ctleft">
		<tr><td rowspan="11" class="small">23.</td><td colspan="2">Причины перинатальной смерти:</td><td rowspan="11" class="small">&nbsp;</td><td colspan="5">Код по МКБ-10</td></tr>
		<tr><td rowspan="2">а)</td><td>основное заболевание или патологическое состояние плода или ребенка</td><td class="diat">{D11}</td><td class="diat">{D12}</td><td class="diat">{D13}</td><td style="text-align: center">{D14}</td><td class="diat">{D15}</td></tr>
		<tr><td class="dashed">{Diag1_Name}</td><td colspan="5">&nbsp;</td></tr>			
...
<tr><td>&nbsp;</td><td><span class="val_1">врачом, только удостоверившим <nobr>смерть</span> - 1,</nobr> <span class="val_2">врачом-акушером-гинекологом, принимавшим <nobr>роды</span> - 2,</nobr> <span class="val_3">врачом-неонатологом (педиатром), лечившим <nobr>ребенка</span> - 3,</nobr> <nobr><span class="val_4">врачом-патологоанатомом</span> - 4,</nobr> <nobr><span class="val_5">судебно-медицинским экспертом</span> - 5,</nobr> <nobr><span class="val_6">акушеркой</span> - 6,</nobr> <nobr><span class="val_7">фельдшером</span> - 7 </nobr><div class="selector">{PntDeathSetType_id}</div></td></tr>
<tr><td>&nbsp;</td><td>на основании: <span class="val_1">осмотра <nobr>трупа</span> - 1,</nobr> <span class="val_2">записей в медицинской <nobr>документации</span> - 2,</nobr> <span class="val_3">собственного предшествовавшего <nobr>наблюдения</span> - 3,</nobr> <nobr><span class="val_4">вскрытия</span> - 4 </nobr><div class="selector">{PntDeathSetCause_id}</div></td></tr>
<tr><td colspan="2">	
	<table class="ct ctcenter" style="margin-top:1em;">
		...
		<tr><td class="tleft" style="padding-bottom:2em;">(должность врача (фельдшера, акушерки),</br>заполнившего Медицинское свидетельство</br>о перинатальной смерти)	</td><td>(подпись)</td><td>(фамилия, имя, отчество)</td></tr>
		<tr>
