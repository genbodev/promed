...
<td style="text-align: right;">{EvnPL_VizitCount}</td>
<td>{EvnPL_IsFinish}</td>
<td>{Diag_Name}</td>
<td>{MedPersonal_Fio}</td>
<td style="text-align: center;">{EvnPL_setDate}</td>
<td style="text-align: center;">{EvnPL_disDate}</td>
</tr>
{/search_results}
