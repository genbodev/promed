...
class TTimetableMedServiceOrg extends TTimetable {
	...
	function __construct( $arFields = NULL, $arReserved = NULL, $data = NULL ) {
		...
		if ( isset($arFields) ) {
			...
			$this->TimetableMedServiceOrg_updDT = DateTime::createFromFormat('d.m.Y H:i:s', $arFields['TimetableMedServiceOrg_updDT']);
			$this->TimetableMedServiceOrg_begTime = DateTime::createFromFormat('d.m.Y H:i:s', $arFields['TimetableMedServiceOrg_begTime']);
