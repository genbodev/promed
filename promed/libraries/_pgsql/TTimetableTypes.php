...
class TTimetableTypes
{
	...
	public static function loadTypes() {
		...
		if ( $DB ) {
			$sql = "
				select
					tt.TimetableType_id as \"TimetableType_id\",
					tt.TimetableType_Name as \"TimetableType_Name\",
					tt.TimetableType_Style as \"TimetableType_Style\",
					tt.TimetableType_StylePerson as \"TimetableType_StylePerson\",
					tta.TimetableTypeAttribute_Code as \"TimetableTypeAttribute_Code\",
					tta.TimetableTypeAttribute_Type as \"TimetableTypeAttribute_Type\"
				from dbo.v_TimetableType tt
				left join TimetableTypeAttributeLink ttal on tt.TimeTableType_id = ttal.TimeTableType_id
				left join TimetableTypeAttribute tta on tta.TimetableTypeAttribute_id = ttal.TimetableTypeAttribute_id
