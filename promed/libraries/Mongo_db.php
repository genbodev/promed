...
class Mongo_db {
	...
	*/
	...
	private function connection_string() 
	{
		...
		$this->url	= trim($this->CI->config->item('mongo_url'));
		...
		$this->fields_uncase = trim($this->CI->config->item('fields_uncase'));
		...
		if (isset($this->url))
		{
			$connection_string .= $this->url;
		}
		else if (isset($this->port) && ! empty($this->port))
		{
