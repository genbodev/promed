 ...
 *--------------------------------------------------------------------
 * Revision History
 * v2.01	15 jul	2008	Jean-Sйbastien Goupil	Fix bugs
 * v2.00	23 apr	2008	Jean-Sйbastien Goupil	New Version Update
 * v0.8		19 feb	2008	Jean-Sйbastien Goupil	First Beta
 *--------------------------------------------------------------------
...
class BCGpdf417 extends BCGBarcode2D {
	...
	public function __construct() {
		...
		//Поубивал бы за использование глобальных переменных в библиотеке!
