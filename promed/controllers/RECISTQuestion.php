...
/**
 * RECISTQuestion - RECIST
 * сделано в режиме совместимости с OnkoCtrl
 *
 * @access       public
 * @copyright    Copyright (c) 2019 Swan Ltd.
 *  
 * @property RECISTQuestion_model $dbmodel
 */
class RECISTQuestion extends swController {
    ...
    var $model_name = "RECISTQuestion_model";
	...
	public function loadMedicalFormAnswers() {    	
		$data = $this->ProcessInputData('GetOnkoCtrlProfileJurnal', true);
		if ($data === false) {
			return false;
		}
		$response = $this->dbmodel->loadMedicalFormAnswers($data);
		$this->ProcessModelList($response, true, true)->ReturnData();
	}
}
