...
/**
 * ProfService - контроллер для работы с АРМ профосмотров
 *
...
class ProfService extends swController {
	...
	function __construct()
	{
		parent::__construct();
		$this->load->database();
		$this->load->model('ProfService_model', 'dbmodel');
	}
	...
	function getProfGoalFormList() {
		$response = $this->dbmodel->getProfGoalFormList();
