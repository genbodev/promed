...
/**
 * BSK_Register - контроллер для БСК (Башкирия)
...
class BSK_Register extends swController
{
    var $model = "BSK_Register_model";
	 ...
	 */
	function getListFormTemplate()
	{
		$data = $this->ProcessInputData('getListFormTemplate', true);
		if ($data === false) {
			return false;
		}
		
		$list = $this->dbmodel->getListFormTemplate($data);
