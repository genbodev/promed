...
/**
 * EvnNotifyOrphan - контроллер формы "Направление на включение в регистр"
 *
 ...
 * @version      10.2012
 *
 * @property EvnNotifyOrphan_model $dbmodel
 */

class EvnNotifyOrphan extends swController 
{
    ...
    var $inputRules = array(
			...
			'save' => array(
				...
				array(
					'field' => 'Lpu_oid',
					'label' => 'ЛПУ, в которой пациенту впервые установлен диагноз орфанного заболевания',
					'rules' => 'required',
					'type' => 'id'
				),
			)
	...
	function __construct()
	{
		...
		$this->load->database();
		$this->load->model('EvnNotifyOrphan_model', 'dbmodel');
	}
